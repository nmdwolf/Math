\chapter{Calculus}
	...
	\begin{theorem}[Intermediate value theorem]\index{Intermediate value theorem}\label{calculus:theorem:intermediate_value_theorem}
		Let $I=[a,b]\subset\mathbb{R}$ be a compact interval. Let $f:I\rightarrow\mathbb{R}$ be a continuous function. For every $c\in[f(a),f(b)]$ there exists an $x_0\in I$ such that $f(x_0) = c$.
	\end{theorem}
	
	\begin{theorem}[Darboux's theorem]\index{Darboux!theorem for differentiable functions}
		Let $f$ be a differentiable function on a closed interval $I$. Then $f'$ has the intermediate value property\footnotemark.
		\footnotetext{This means that the function satisfies the conclusion of the intermediate value theorem \ref{calculus:theorem:intermediate_value_theorem}.}
	\end{theorem}
	...
	\section{Derivative}\index{derivative}
    	\subsection{Single variable}
            ...
            \newdef{Differentiablity class}{
            	\label{calculus:differentiablity_class}
            ...
            \newdef{Smooth function}{\index{smooth}
            	\label{calculus:smooth}
                A function $f$ is said to be smooth if it is of class \textbf{C$^\infty$}.
            }
            \newdef{Analytic function}{\index{analytic}
            	\label{calculus:analytic}
...
\subsection{Comparison test}
    ...
    \sremark{$S_b$ is said to minorize $S_a$.}
    
    \begin{theorem}[Comparison test]\index{convergence!comparison test}
...
\subsection{Integral test}
	\begin{theorem}[MacLaurin-Cauchy integral test]\index{convergence!integral test}
...
\subsection{Ratio test}
	\begin{theorem}[d'Alembert's ratio test]\index{convergence!ratio test}\index{d'Alembert!test}
		\begin{equation}
...
\subsection{Root test}
	\begin{theorem}[Cauchy's root test]\index{convergence!root test}\index{Cauchy!root test}
		\begin{equation}
    ...
    \newdef{Radius of convergences}{\index{convergence!radius}
    	The number $\stylefrac{1}{R}$, where $R$ is defined as in the Cauchy test, is called the radius of convergence.
    }

\subsection{Gauss's test}\index{convergence!Gauss test}\index{Gauss!convergence test}
	\begin{equation}
...
\section{Asymptotic expansions}
    ...
    \newmethod{Borel transform}{\index{Borel!transform}
    	Define the function $F(x) = \ds\sum_{n=0}^{+\infty}\stylefrac{a_n}{n!}x^n$. If the integral
        \begin{equation}
        	\int_0^{+\infty}e^{-t}F(xt)dt < +\infty\qquad,\qquad \forall x \in \mathbb{R}
        \end{equation}
        then $F(x)$ is called the Borel transform of $f(x)$. Furthermore the integral will give a convergent expression for $f(x)$.
    }
    \begin{proof}
    \begin{equation}
    	\begin{array}{ccl}
    ...
    \end{proof}
    \begin{theorem}[Watson's theorem]\index{Watson!theorem}

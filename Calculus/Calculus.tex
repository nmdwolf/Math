...
\subsection{Single variable}
	...
	\begin{theorem}[Boman]\index{Boman}
		Consider a function $f:\mathbb{R}^d\rightarrow\mathbb{R}$. If for every smooth function $g:\mathbb{R}\rightarrow\mathbb{R}^d$ the composition $f\circ g$ is also smooth then the function $f$ is smooth too.\footnote{In the context of \autoref{part:diffgeom}: \textit{Differential Geometry}, this theorem can be generalized to smooth manifolds by replacing $\mathbb{R}^d$ with a smooth manifold $M$.}
	\end{theorem}
	...
	\begin{theorem}[Schwarz' theorem\footnotemark]\index{Schwarz!theorem for second derivatives}\index{Clairaut's theorem}
		\footnotetext{Also called \textbf{Clairaut's theorem}.}
		Let $f\in C^2(\mathbb{R}^n, \mathbb{R})$. The mixed partial derivatives of $f$ coincide:
		\begin{gather}
...
\subsection{Fundamental theorems}\index{Fundamental theorem!of calculus}
	...
	\begin{theorem}[Differentiation under the integral sign\footnotemark]\index{Leibniz!integral rule}

...
\section{Complex algebra}
    ...
    \newdef{Complex conjugate}{\index{complex conjugate}
        Complex conjugation $\overline{z}:a+bi\mapsto a-bi$ is an involution, i.e. $\overset{=}{z} = z$. It is sometimes denoted by $z^*$ instead of $\overline{z}$, but we will adopt the former notation (unless this would cause confusion).
    }

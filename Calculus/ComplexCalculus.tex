...
\section{Contour integrals}
    ...
    \newdef{Contour}{\index{contour}
        ...
        \begin{gather}
            \begin{cases}
                ...
                y = y(t)
            \end{cases}
            \longrightarrow\quad z(t) = x(t) + iy(t).
        \end{gather}
    }
    ...
    \begin{theorem}[Sokhotski-Plemelj\footnotemark]\index{Sokhotski-Plemelj}\label{complexcalculus:sokhotski_plemelj}
...
\section{Laurent series}
    ...
    \begin{definition}[Laurent series]\index{Laurent!series}\index{annulus}\index{principal!part}\label{complexcalculus:laurent_series}
...
\subsection{Poles}
    ...
    \newmethod{Frobenius transformation}{\index{Frobenius!transformation}
        To study the behaviour of a function $f(z)$ at $z\rightarrow\infty$, one can apply the Frobenius transformation $h = 1/z$ and study the limit $\lim_{h\rightarrow0}f(h)$. For example, a singularity at $\infty$ is defined as a singularity of $f(1/z)$ at 0.
    }
    \begin{property}
...
\subsection{Branch cuts}
    ...
    \newformula{Roots}{\index{root}
        ...
        \begin{gather}
            \left\{\sqrt[n]{r}\exp\left(i\frac{\theta + 2\pi k}{n}\right):k\in\{0,1,\ldots,n\}\right\}.
        \end{gather}
    }
    \newformula{Complex logarithm}{\index{logarithm}
        The natural logarithm can be continued into the complex plane (as a multi-valued function) as follows:
        \begin{gather}
            \text{LN}(z) = \big\{\ln(r) + i(\theta + 2\pi k):k\in\mathbb{Z}\ \big\}.
        \end{gather}
    }

    \newdef{Branch}{\index{branch}
        The problem with these two formulas is that they represent multi-valued functions. To get an unambiguous image it is necessary to fix a value of the parameter $k$. By doing so there will arise curves, called \textbf{branch cuts}, in the complex plane where the function is discontinuous. A \textbf{branch} is then defined as a particular choice of the parameter $k$.
    ...
    \newdef{Branch cut}{
        A line connecting exactly two branch points (one possibly being $\infty$) is called a branch cut. In case there exist multiple branch cuts, they should never cross.
    }
...
\subsection{Residue theorem}
    ...
    \newdef{Residue}{\index{residue}\label{complexcalculus:residue_def}
        ...
        By applying Formula \ref{complexcalculus:contour_integral} to a polynomial function, one finds
        \begin{gather}

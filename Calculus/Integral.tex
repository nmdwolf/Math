...
\subsection{Measurable functions}
    ...
    \end{property}
    \begin{property}
        Let $f$ be a bounded measurable function defined on the interval $[a,b]$. For every $\varepsilon>0$ there exists a step function $h$ such that $\int_a^b|f-h|\ d\mu<\varepsilon$.
    \end{property}
...
\subsection{Integrable functions}
    ...
    \newdef{Integrable function}{\index{integrable}\label{lebesgue:integrable_function}
        ...
        \end{gather}
        If only one of the functions $f^+, f^-$ is integrable, we call $f$ \textbf{quasi-integrable}.
    }
    ...
    \begin{property}
        ...
        \begin{itemize}
            ...
            \item $\forall c\in\mathbb{R}:\int_E(cf)\ d\mu = c(\int_Ef\ d\mu)$,
            \item $f$ is finite a.e.,
            \item $|\int f\ d\mu|\leq\int|f|\ d\mu$, and

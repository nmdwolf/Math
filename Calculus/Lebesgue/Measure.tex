...
\subsection{General definitions}
	...
	\newdef{Almost everywhere\footnotemark}{\label{lebesgue:almost_everywhere}
...
\subsection{Lebesgue measure}
	...
	\end{property}
        ...
        \begin{theorem}[Carath\'eodory's criterion]\index{Carath\'eodory!criterion}\index{Lebesgue!measure}\index{measurable!set}

...
\section{Fibre bundles}
	...
	\newdef{Bundle}{\index{bundle}
		A bundle is a triple $(E, B, \pi)$ where $E, B$ are topological manifolds and $\pi$ is a continuous surjective map.
	}
	...
	\newdef{Equivalent fibre bundles}{\index{gauge!transformation}
		...
		\end{equation}
		This transformation is called a \textbf{gauge transformation} (especially in physics) .

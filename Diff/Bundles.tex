...
\section{General bundles}
	...
	\newdef{Bundle}{\index{bundle}
		A bundle is a triple $(E, B, \pi)$ where $E$ and $B$ are topological spaces and $\pi$ is a continuous map.\footnote{Sometimes one requires that the map $\pi$ is also surjective. However then we cannot make the association \textbf{Bundle}$(X)\cong\textbf{Top}/X$ of categories anymore.}
	}

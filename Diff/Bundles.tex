...
\section{Principal bundles}
	...
	\newdef{Vertical automorphism}{\index{vertical!automorphism}\index{gauge!transformation}
		Consider a principal $G$-bundle $\pi:P\rightarrow M$. An automorphism $f$ of this bundle is said to be vertical if it covers the identity, i.e. $\pi\circ f = \pi$. It is exactly this subgroup Aut$_V(P)\subset\text{Aut}(P)$ which is known as the \textbf{group of gauge transformations} or \textbf{gauge group}\footnote{Do not confuse with the structure group $G$ which is also sometimes called the gauge group in physics.} in physics.
	}

...
\section{Universal bundle}
	...
	\remark{There also exists a subtly different notion of universal bundles and their associated classifying property. When we require the total space of the universal bundle to be contractible instead of weakly contractible, the mapping space $[X, BG]$ only classifies numerable principal bundles\footnote{See definition \ref{manifolds:numerable_bundle}.}, but now over arbitrary base spaces $X$.}

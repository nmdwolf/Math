...
\section{Reduction of the structure group}
	...
	\newdef{Reduction}{\index{reduction}
		...
		More generally\footnote{This is more general since it allows for covering maps $\lambda:H\rightarrow G$. (See for example the definition of spinor bundles in the next section.)}, a principal bundle $\prin{H}{\tilde{P}}{M}$ with structure group $H$ is an $H$-reduction of $P$ if there exists a vertical bundle morphism $\tilde{P}\rightarrow P$.
	}

...
\section{Complex structures}
	...
	\newdef{Almost complex structure}{
		...
		This structure induces a decomposition in so-called holomorphic and anti-holomorphic components:\[TM^{\mathbb{C}} = TM^+\oplus TM^-\] where both bundles have the same dimension. When the coordinates on $M$ are denoted by $\{x^k\}_{k\leq 2n}$ the bases for these two subbundles are given by \[\left\{\pderiv{}{z^k} = \frac{1}{2}\left(\pderiv{}{x}_{^{2k-1}} - i\pderiv{}{x}_{^{2k}}\right)\right\}_{k\leq n}\] and \[\left\{\pderiv{}{\overline{z}^k} = \frac{1}{2}\left(\pderiv{}{x}_{^{2k-1}} + i\pderiv{}{x}_{^{2k}}\right)\right\}_{k\leq n}\] respectively.
	}
	...
	\newdef{K\"ahler manifold}{\index{K\"ahler!manifold}
		...
		\begin{itemize}
			\item $M$ is Hermitian:
				...
				\end{gather}
				where $g_{\mathbb{C}}$ is defined as the extension of $g$ from $TM$ to $T^{\mathbb{C}}M$.
		...
		\end{itemize}
		or (here the symplectic structure can be recovered using the K\"ahler form)
		\begin{itemize}
			\item $M$ is Hermitian.

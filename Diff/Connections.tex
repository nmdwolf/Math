...
\subsection{Ehresmann connection}\index{Ehresmann connection}
	...
	\newdef{Ehresmann connection}{
		Let $(P, M, \pi, G)$ be a principal bundle. An Ehresmann connection is a $\mathfrak{g}$-valued 1-form $\omega:TP\rightarrow\mathfrak{g}$ that satisfies the following 2 conditions:

...
\subsection{Vertical vectors}
    ...
    \newdef{Vertical vector}{\index{bundle!vertical}
        Let $\pi:E\rightarrow B$ be a smooth fibre bundle. The subbundle $\text{Vert}(TE):=\ker(\pi_\ast)$ of $TE$ is called the vertical (sub)bundle over $E$. Elements of the vertical space $\text{Vert}(T_pE)$ are called vertical vectors.
    }
...
\subsection{Chern classes}
    ...
    \newdef{Theta characteristic}{label{theta characteristic}

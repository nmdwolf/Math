...
\section{Basic definitions}
	...
	\begin{notation}
		\nomenclature[S]{$K^0(X)$}{K-theory over a compact Haussdorf space $X$.}
	...
	\newdef{Virtual vector bundle}{\index{virtual!vector bundle}\index{vector bundle}
		The elements of $K^0(X)$ are of the form $([E], [E'])$ and can be formally written as the difference $[E] - [E']$. These elements are called virtual (vector) bundles.
	}
	\newdef{Virtual rank}{\index{virtual!rank}\index{rank}
		For a pointed topological space $(X, x_0)$ the virtual rank of the virtual bundle $([E], [E'])$ is defined as follows:
		\begin{equation}
			\text{rk}_{x_0}([E] - [E']) = \text{rk}_{x_0}(E) - \text{rk}_{x_0}(E')
		\end{equation}
	}
	
	\begin{property}
		Property \ref{bundles:prop:hausdorff} implies that every virtual bundle is of the form $[E] - [X\times\mathbb{R}^n]$.
	\end{property}

...
\section{\difficult{Poisson algebras and Lie superalgebras}}
...
\section{\difficult{Higher structures}}
...
\subsection{Batalin-Vilkovisky formalism}\label{section:bv_formalism}
    ...
    \begin{align*}
        ...
        &\ \ \vdots
    \end{align*}
    By dualising we recover some Lie algebra-like structures (we put $[\cdot]_1:=d$):
    \begin{align*}
        d^2&=0\\

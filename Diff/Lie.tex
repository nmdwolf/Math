...
\subsection{One-parameter subgroups}
    ...
    \newdef{One-parameter subgroup}{\index{one-parameter subgroup}\label{group:one_parameter_subgroup}
        A one-parameter (sub)group (of a Lie group $G$) is a Lie group morphism $\Phi:\mathbb{R}\rightarrow G$ from the additive group of real numbers to $G$.
    }
...
\subsection{\difficult{Lie algebra cohomology}}\index{cohomology!Lie algebra}\label{section:lie_algebra_cohomology}
    ...
    Although the following construction can be generalized almost verbatim to the infinite-dimensional case, we only state it for finite dimensions:

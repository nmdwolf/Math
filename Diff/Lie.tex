...
\subsection{Dynkin diagrams}
        ...
        \newdef{Weyl group}{\index{Weyl!group}
        	...
        	\footnotetext{Consider the \textit{sharp} map \ref{manifolds:sharp_map} where one replaces the metric $g$ by the Killing form $K$. The dual Killing form $K^*$ is then defined as \[K^*(\cdot, \cdot) = K(\cdot^\sharp, \cdot^\sharp)\].}
        }

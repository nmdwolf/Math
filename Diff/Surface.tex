...
\section{Curves}
    ...
    \newdef{Regular curve}{\index{regular!curve}
        Let $c:I\rightarrow\mathbb{R}^n$ be a curve defined on an interval $I$. It is said to be regular\footnote{This is generalized in property \ref{diff:regular_point}.} if $\deriv{c}{t}\neq0$.
    }

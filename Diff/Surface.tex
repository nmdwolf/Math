...
\section{Curves}
    ...
    \newdef{Regular curve}{\index{regular!curve}
        Let $c(t):I\rightarrow\mathbb{R}^n$ be a curve defined on an interval $I$. $c(t)$ is said to be regular\footnote{This is generalized in property \ref{manifolds:regular_point}.} if $\deriv{c}{t}(t)\neq\mathbf{0}$ for all $t\in I$.
    }

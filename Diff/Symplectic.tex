...
\section{Symplectic manifolds}
    ...
    \begin{construct}
        One can generalize the construction of the canonical one-form on cotangent bundles $T^*M$ to exterior powers of the cotangent bundle through equation \ref{diff:liouville}:
        \begin{gather}

...
\section{Neighbourhoods}
	...
	\begin{example}[Monad]\index{monad}
		Let $M$ be a set. Given a neighbour relation $\sim$ on $M$, the (first order) monad around $x\in M$ is defined as:
		\begin{equation}
	...
	\newdef{Geometric distribution}{\index{distribution!involutive}
		Let $M$ be a set equipped with a neighbour relation $\sim$. A (geometric) distribution on $M$ is a reflexive symmetric refinement $\approx$ of $\sim$. A distribution is said to be \textbf{involutive} if
		\begin{equation}
	...
	\newdef{Integral subset}{\index{integral!subset}
		Let $M$ be a set equipped with a neighbour relation $\sim$ and a distribution $\approx$. A subset $N\subseteq M$ is said to be integral with respect to $\approx$ if $\approx$ and $\sim$ coincide on $N$.
	}

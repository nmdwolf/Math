...
\subsection{Exterior derivative}
	...
	\begin{property}\index{Leibniz!rule}\label{forms:exterior_derivative_properties}
		...
		\begin{itemize}
			...
			\item The exterior derivative is an $\mathbb{R}$-linear map.\newline$ $\newline These two items in the above list say that $(\Omega^\bullet(M),d)$ is not just a graded algebra but in fact a dg-algebra (see definition \ref{linalgebra:dg_algebra}).\newline

...
\section{Current topics}
    ...
    \begin{itemize}
        ...
        \item Turaev--Viro and Reshetikhin--Turaev models,
        \item (F)FRS construction and $F$-symbols,
        \item pAQFT,
        ...
        \item higher-form and noninvertible symmetries,
        \item nonconventional computational methods: e.g.~distributed representations (see work by D.~Kleyko), Fourier Holographic Reduced Representations,
        \item ...
    \end{itemize}
...
\section{Personal notes}
    ...
    \begin{center}
        \begin{tabular}{|l|l|c|c|}
            ...
            \hline
            Haegeman, J.&Strongly correlated systems\\
            Hohloch, S.&Capita Selecta:&\ref{chapter:symplectic}&Partially\\
            &\qquad Differentiaalmeetkunde&&\\
            Hohloch, S.&Integrable Hamiltonian Systems&\ref{chapter:symplectic}&Partially\\
            Mestdagh, T.&Differentiaalmeetkunde I&\ref{chapter:curves_surfaces}, \ref{chapter:manifolds}, \ref{chapter:riemann}&Done\\
            Van Neck, D.&Inleiding tot de theoretische fysica&\ref{chapter:lagrange}&Partially\\
            \hline
        \end{tabular}
    \end{center}

\nomenclature[A_PRP]{PRP}{predictable representation property}
\nomenclature[A_EMM]{EMM}{equivalent martingale measure}
\nomenclature[A_ESM]{ESM}{equivalent separating measure}
...
\nomenclature[A_PID]{PID}{principal ideal domain}
\nomenclature[A_UFD]{UFD}{unique factorization domain}
...
\nomenclature[O_Re]{$\mathrm{Re}$, $\Re$}{real part of a complex number}
\nomenclature[O_Im]{$\mathrm{Im}$, $\Im$}{imaginary part of a complex number}
\nomenclature[O_arg]{$\arg$}{argument of a complex number}
\nomenclature[O_mod]{$|\cdot|$}{modulus of a complex number}
...
\nomenclature[O_linearimp]{$A\multimap B$}{linear implication}
\nomenclature[O_fieldvar]{$\delta_\xi\phi$}{field variation (equal to $\mathcal{L}_\xi\phi$)}
...
\nomenclature[S_Grp]{$\symbfsf{Grp}$}{category of groups and group homomorphisms}
\nomenclature[S_Ab]{$\symbfsf{Ab}$}{category of Abelian groups}
...
\nomenclature[S_Hom]{$\hom_{\symbfsf{C}}(V,W)$, $\symbfsf{C}(V,W)$}{collection of morphisms between two objects $V,W$ in a category $\symbfsf{C}$}
...
\nomenclature[S_Psh]{$\symbfsf{Psh}(\symbfsf{C}),\widehat{\symbfsf{C}}$}{category of presheaves on a (small) category $\symbfsf{C}$}
...
\nomenclature[S_Top]{$\symbfsf{Top}$}{category of topological spaces and continuous functions}
\nomenclature[S_Open]{$\symbfsf{Open}(X)$}{category of open subsets of a topological space $X$}
\nomenclature[S_Vectk]{$\symbfsf{Vect}_{\mathfrak{K}}$}{category of vector spaces and linear maps over a field $\mathfrak{K}$}
\nomenclature[S_CH]{$C_\bullet$}{chain complex}
\nomenclature[S_CHCat]{$\symbfsf{Ch}(\symbfsf{A})$}{category of chain complexes with objects in an additive category $\symbfsf{A}$}
\nomenclature[S_GLn]{$\GL(n,\mathfrak{K})$}{general linear group: group of invertible $n\times n$-matrices over a field $\mathfrak{K}$}
\nomenclature[S_SLn]{$\mathrm{SL}_n(\mathfrak{K})$}{special linear group: group of all $n\times n$-matrices with unit determinant over a field $\mathfrak{K}$}
\nomenclature[S_OOrtho]{$\mathrm{O}(n,\mathfrak{K})$}{group of $n\times n$ orthogonal matrices over a field $\mathfrak{K}$}
\nomenclature[S_Unit]{$\mathrm{U}(n,\mathfrak{K})$}{group of $n\times n$ unitary matrices over a field $\mathfrak{K}$}
\nomenclature[S_Symp]{$\mathrm{Sp}(n,\mathfrak{K})$}{group of matrices preserving a canonical symplectic form over a field $\mathfrak{K}$}
...
\nomenclature[S_span]{$\symbfsf{Span(C)}$}{span category over a category $\symbfsf{C}$}
\nomenclature[S_Grpd]{$\symbfsf{Grpd}$}{category of groupoids}
\nomenclature[S_Law]{$\symbfsf{Law}$}{category of Lawvere theories}
...
\nomenclature[S_Man]{$\symbfsf{Man}^p$}{category of $C^p$-manifolds}
\nomenclature[S_Diff]{$\symbfsf{Diff}$}{category of smooth manifolds}
\nomenclature[S_Cinfty]{$C^\infty_p(M)$}{ring of smooth functions $f:M\rightarrow\mathbb{R}$ on a neighbourhood of $p\in M$}
\nomenclature[S_Sheaf]{$\symbfsf{Sh}(X)$}{category of sheaves on a topological space $X$}
\nomenclature[S_Nerve]{$N\symbfsf{C}$}{simplicial nerve of a small category $\symbfsf{C}$}
\nomenclature[S_Kan]{$\symbfsf{Kan}$}{category of Kan complexes}
\nomenclature[S_simpcat]{$\simplex$}{simplex category}
\nomenclature[S_Kgroup]{$K(A)$}{Grothendieck completion of a monoid $A$}
\nomenclature[S_SsetQuillen]{$\symbfsf{sSet}_{\text{Quillen}}$}{Quillen's model structure on simplicial sets}
...
\nomenclature[S_Topos]{$\symbfsf{Topos}$}{(2-)category of (elementary) topoi and geometric morphisms}
\nomenclature[S_Shsite]{$\symbfsf{Sh}(\symbfsf{C},J)$}{category of $J$-sheaves on a site $(\symbfsf{C},J)$}
...
\nomenclature[S_Lie]{$\symbfsf{Lie}$}{category of Lie groups}
\nomenclature[S_lie]{$\mathfrak{Lie}$}{category of Lie algebras}
\nomenclature[S_K]{$K^0(X)$}{$K$-theory over a (compact Hausdorff) space $X$}
\nomenclature[S_Vect]{$\symbfsf{Vect}(X)$}{category of vector bundles over a manifold $X$}
...
\nomenclature[S_Meas]{$\symbfsf{Meas}$}{
    \begin{itemize}
        \item category of measurable spaces and measurable functions, or
        \item category of measure spaces and measure-preserving functions
    \end{itemize}    
}
\nomenclature[S_L1]{$L^1$}{space of integrable functions}
\nomenclature[S_Sob]{$W^{m,p}(U)$}{Sobolov space in $L^p$ of order $m$}
\nomenclature[S_DiffSp]{$\symbfsf{DiffSp}$}{category of diffeological spaces and smooth maps}
\nomenclature[S_Cinf]{$\symbfsf{C^\infty}$, $\symbfsf{SmoothSet}$}{category of smooth sets}
\nomenclature[S_CSmAlg]{$\symbfsf{C^\infty Ring}$, $\symbfsf{C^\infty Alg}$}{category of smooth algebras}
\nomenclature[S_FormalCartSp]{$\symbfsf{FormalCartSp_{diff}}$}{category of infinitesimally thickened Euclidean spaces}
...
\nomenclature[S_naturalfiltration]{$\mathbb{F}^X$}{natural filtration of a stochastic process $\tseq{X}$}
\nomenclature[S_modularform]{$M_k(\Gamma)$}{space of modular forms of weight $k\in\mathbb{R}$}
\nomenclature[S_cuspform]{$S_k(\Gamma)$}{space of cusp forms of weight $k\in\mathbb{R}$}
\nomenclature[S_idrationalfrac]{$I(x)$}{rational fractions over an integral domain $I$}
\nomenclature[S_ideal]{$I(S)$}{vanishing ideal on an algebraic set $S$}
\nomenclature[S_im]{$\im(f)$}{image of a function $f$}
\nomenclature[S_hyper]{$H(X)$}{hyperspace of a topological space $X$}
\nomenclature[S_Et]{$\symbfsf{Et}_X$}{category of \'etale morphisms over a scheme $X$}
\nomenclature[S_FinEt]{$\symbfsf{FEt}_X$}{category of finite \'etale morphisms over a scheme $X$}
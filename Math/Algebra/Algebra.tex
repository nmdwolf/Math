\chapter{Algebra}
    ...
    For the later sections on (co)homology theory, some terminology from \cref{chapter:hom_alg} is used.
...
\section{Algebraic structures}
    ...
    \begin{property}[Eckmann-Hilton argument]\index{Eckmann-Hilton!argument}\label{algebra:eckmann_hilton}
        ...
        \end{gather}
        for all $a,b,c,d\in M$. The two monoid structures coincide and are in fact Abelian. (This property admits a vast generalization, see \cref{cat:eckmann_hilton}.)
    \end{property}
...
\subsection{Abelian groups}
    ...
    \newdef{Commutator subgroup\footnotemark}{\index{commutator!subgroup}\index{derived!subgroup}
        ...
        \end{gather}
        To ease the notation these groups are often denoted by $G^{(i)}$ such that $G^{(0)}:=G$ and $G^{(i)}:=[G^{(i-1)},G^{(i-1)}]$.
    }
    \newdef{Solvable group}{\index{group!solvable}
...
\subsection{Cosets}\index{co-!set}
    ...
    \begin{property}[Tower property]\index{tower law}\label{group:tower_rule_groups}
...
\subsection{Direct products}
    ...
    \begin{property}[Normal subgroups]
        ...
        If the subgroups $H$ and $N$ have presentations $\langle S_H\mid R_H \rangle$ and $\langle S_N\mid R_N \rangle$, the direct product is given by
        \begin{gather}
...
\subsection{Free groups}
    ...
    \begin{theorem}[Fundamental theorem of finitely generated groups]\index{fundamental theorem!of finitely generated groups}\index{torsion!group}\label{group:theorem:free_group}
        ...
        \begin{gather}
            G = F/F'
        \end{gather}
        or as a direct sum of a free, finitely generated Abelian group and a torsion group (\cref{group:torsion_group}):
        \begin{gather}
...
\subsection{Ideals}
    ...
    \begin{property}[Adic topology]\index{adic topology}\index{Krull!topology}
...
\section{Polynomials}\index{poly-!nomial}\label{section:algebraic_numbers}
...
\subsection{Field extensions}
    ...
    \newdef{Degree}{\index{degree!of extension}
        If $L/K$ is a field extension, $L$ can be given the structure of a $K$-vector space (\cref{linalgebra:vector_space}). The dimension of this vector space is called the degree of the extension $K$. It is often denoted by $[L:K]$.
    }

    The following property is very similar to the tower rule for finite groups \ref{group:tower_rule_groups}:
    ...
    \end{property}
    \begin{property}
        The minimal polynomial of every algebraic element is irreducible.
    \end{property}
    ...
    \begin{property}[Separable splitting field]
    ...
    \newdef{Normal extension}{\index{normal!extension}
...
\subsection{Galois extensions}
    ...
    \newdef{Galois extension}{\index{Galois!extension}\index{Krull!topology}
...
\subsection{Radicals}
    ...
    \newdef{Radical extension}{\index{radical!extension}

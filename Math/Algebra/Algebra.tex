...
\subsection{Algebraic geometry}
    ...
    \begin{property}[Characterization by invertible complements]\label{algebra:local_ring_invertible}
        A ring $R$ is local if and only if there exists a maximal ideal $\mathfrak{m}$ such that every element in the complement $R\backslash\mathfrak{m}$ is invertible.
    \end{property}

...
\subsection{\difficult{Hochschild and cyclic homology}}\index{homology!Hochschild}
    ...
    \begin{remark}[Cohomology]\index{cohomology}
        Hochschild cohomology of $A$ can be obtained by dualizing: $HC^k(A):=\hom\bigl(HC_k(A),K\bigr)$, where $K$ is the field over which $A$ is defined.
    \end{remark}

    \newdef{Cyclic homology}{\index{homology!cyclic}

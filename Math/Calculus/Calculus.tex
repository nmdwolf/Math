...
\subsection{Convergence tests}\index{convergence}
    ...
    \begin{property}
        ...
        \begin{gather}
            \bigintsss_n^{+\infty} f(x)\,ndx\leq\sum_{i=n}^{+\infty} a_i \leq f(n) + \bigintsss_n^{+\infty} f(x)\,dx\,.
        \end{gather}
    \end{property}
...
\section{Integration theory}\index{Riemann!integral}
    ...
    \newdef{Improper Riemann integral}{\label{calculus:improper_integral}
        \begin{gather}
            \bigintsss_{-\infty}^{+\infty}f(x)\,dx := \lim_{\substack{a\rightarrow-\infty\\b\rightarrow+\infty}}\bigintsss_a^bf(x)\,dx
        \end{gather}
    ...
    \begin{formula}[Differentiation under the integral sign\footnotemark]\index{Leibniz!integral rule}\label{calculus:leibniz_integral_rule}
        ...
        \begin{gather}
            \deriv{}{x}\bigintsss_{a(x)}^{b(x)}f(x,y)\,dy = f\bigl(x,b(x)\bigr)b'(x) - f\bigl(x,a(x)\bigr)a'(x) + \bigintsss_{a(x)}^{b(x)}\pderiv{f(x,y)}{x}\,dy
        \end{gather}
    \end{formula}
    ...
    \newdef{Borel transform}{\index{Borel!transform}\label{calculus:borel_transform}
        ...
        If
        \begin{gather}
            \bigintsss_0^{+\infty}e^{-t}F(xt)\,dt<+\infty
        \end{gather}
        ...
        \begin{mdframed}[roundcorner=10pt, linecolor=blue, linewidth=1pt]
            \begin{proof}
                ...
                \begin{align*}
                    \bigintsss_0^{+\infty}F(xt)e^{-t}\,dt&=\sum_{n=0}^N\bigintsss_0^{+\infty}\frac{a_n}{n!}x^nt^ne^{-t}\,dt\\
                    &=\sum_{n=0}^N\frac{a_n}{n!}x^n\bigintsss_0^{+\infty}t^ne^{-t}\,dt\\
...
\subsection{Euler integrals}\index{Euler!integral}
   ...
   \newformula{Beta function}{\index{beta function}\label{calculus:beta_function}
       The beta function (also known as the \textbf{Euler integral of the first kind}) is defined as follows:
        \begin{gather}
            B(x,y) := \bigintsss_0^1t^{x-1}(1-t)^{y-1}\,dt\,.
        \end{gather}
    }
   ...
   \newformula{Gamma function}{\index{gamma!function}\label{calculus:gamma_function}
       The gamma function (also known as the \textbf{Euler integral of the second kind}) is defined as follows:
        \begin{gather}
            \Gamma(x) := \bigintsss_0^{+\infty}t^{x-1}e^{-t}\,dt\,.
        \end{gather}
    }
...
\subsection{Gaussian integrals}\index{Gauss!integral}
    ...
    \newformula{$n$-dimensional Gaussian integral}{\index{Wick!lemma}
        ...
        \begin{gather}
            I\left(A,\vector{b}\right) := \bigintsss_{\mathbb{R}^n}\exp\left(-\frac{1}{2}\vector{x}\cdot A\vector{x} + \vector{b}\cdot\vector{x}\right)\,d^nx\,,
        \end{gather}
        ...
        \begin{gather}
            \bigintsss_{\mathbb{R}^n}\exp\left(-\frac{1}{2}\vector{x}\cdot A\vector{x}\right)f(\vector{x})\,d^nx = \sqrt{\frac{(2\pi)^n}{\det(A)}}\left.\exp\left(\frac{1}{2}\sum_{i,j=1}^nA^{-1}_{ij}\partial_i\partial_j\right)f(\vector{x})\right|_{\vector{x}=0}\,.
        \end{gather}
    ...
    \begin{result}
        ...
        \begin{align}
            I(iA,iJ) &= \bigintsss\exp\left(-i\bigintsss_{\mathbb{R}^n\times\mathbb{R}^n}\varphi(x)A(x,y)\varphi(y)\,d^nx\,d^ny + i\bigintsss_{\mathbb{R}^n}\varphi(x)J(x)\,d^nx\right)[d\varphi]\nonumber\\
            &= C\det(A)^{-1/2}\exp\left(\frac{i}{2}\bigintsss_{\mathbb{R}^n\times\mathbb{R}^n}J(x)A^{-1}(x,y)J(y)\,d^nx\,d^ny\right)\,,
        \end{align}
    ...
    \begin{method}[Feynman diagrams]\index{Feynman!diagram}
        ...
        \begin{gather}
            \bigintsss_{\mathbb{R}^n}\exp\left(-\frac{1}{2}\vector{x}\cdot A\vector{x}\right)x^{i_1}\cdots x^{i_k}\,d^nx = \sqrt{\frac{(2\pi)^n}{\det(A)}}\sum_{\sigma\in S_k}A^{-1}_{\sigma(i_1)\sigma(i_2)}\cdots A^{-1}_{\sigma(i_{k-1})\sigma(i_k)}\,.
        \end{gather}

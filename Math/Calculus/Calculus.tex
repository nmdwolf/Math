...
\section{Integration theory}\index{Riemann!integral}
    ...
    \newmethod{Borel transform}{\index{Borel!transform}\label{calculus:borel_transform}
    ...
    \begin{theorem}[Watson]\index{Watson}
        The uniqueness of the function $F$ is guaranteed if the function $f$ is holomorphic on the domain $\{z\in\mathbb{C}\mid|\arg(z)| < \frac{\pi}{2} + \varepsilon\}$.
    \end{theorem}

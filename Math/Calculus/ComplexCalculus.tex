...
\subsection{Poles}
    ...
    \begin{property}[Polynomials]\index{polynomial}
...
\subsection{Residue theorem}
    ...
    \newdef{Residue}{\index{residue}\label{complex:residue_def}
    ...
    \begin{theorem}[Residue theorem]\index{residue!theorem}\label{complex:residue_theorem}

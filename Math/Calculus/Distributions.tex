...
\subsection{Wave front sets}
    ...
    \newdef{Singular fibre}{\index{cut-off function}
        ...
        This definition says that the singular fibre of a distribution at some point contains those directions such that the Fourier distribution (localized around the point) becomes singular in the given direction and, hence, indicates that the function is not smooth along these directions.
    }
    \begin{property}
...
\section{\difficult{Harmonic analysis}}\index{harmonic!analysis}
    ...
    \begin{theorem}[Haar\footnotemark]\index{Haar}

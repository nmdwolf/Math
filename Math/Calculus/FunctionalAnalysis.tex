\chapter{Functional Analysis}\label{chapter:functional}
    ...
    The main references for this chapter are~\citet{choquet-bruhat_analysis_1991,choquet-bruhat_analysis_2000}. For a revision of topological spaces and inner product spaces, see \labelref{chapter:topology} and \cref{section:innerproduct}, respectively.
...
\subsection{General}
    ...
    \end{theorem}
    \begin{remark}\index{bra-ket notation}\index{notation!braket}

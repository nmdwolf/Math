...
\subsection{Measurable functions}
    ...
    \begin{property}
        ...
        Mesurability is closed under composition. This turns the collection of measurable spaces and measurable functions into a category $\mathbf{Meas}$. (This notation is also used for the subcategory on \textit{measure spaces} (\cref{measure:measure_preserving}).)
    \end{property}
...
\section{Radon--Nikodym theorem}\index{Radon--Nikodym}\label{section:Radon-Nikodym}
    ...
    \begin{definition}[Absolute continuity]\index{continuity!absolute}\label{measure:absolute_continuity}
...
\section{Lebesgue--Stieltjes integral}\index{integration!Lebesgue--Stieltjes}

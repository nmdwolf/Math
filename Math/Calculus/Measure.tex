...
\subsection{General definitions}
    ...
    \newdef{Regular measure}{\label{lebesgue:regular_measure}
        ...
        \begin{enumerate}
            \item\textbf{Outer regularity}: $\mu(B)=\inf\big\{\mu(O)\,\big\vert\,O\text{ open and measurable},O\supset B\big\}$, and
        ...
        \begin{enumerate}
            \item\textbf{Outer regularity}: $\mu(B)=\inf\big\{\mu(O)\,\big\vert\,O\text{ open and measurable},O\supset B\big\}$, and
            \item\textbf{Inner regularity} or \textbf{tightness}: $\mu(B)=\sup\big\{\mu(K)\,\big\vert\,K\text{ compact and measurable},K\subset B\big\}$.
        \end{enumerate}
...
\subsection{Lebesgue measure}
    ...
    \end{property}
    \begin{property}[Translation-invariance]\label{lebesgue:translation_invariant}
    ...
    \begin{construct}[Carath\'eodory's extension theorem\footnotemark]\index{pre-!measure}\index{Hahn--Kolmogorov}\label{lebesgue:caratheodory}
        ...
        Every outer measure $\mu^*$ gives rise to a $\sigma$-algebra consisting of those sets that satisfy Carath\'eodory's criterion (\cref{lebesgue:lebesgue_measure}) with respect to $\mu^*$. Furthermore, consider a \textbf{premeasure} $\mu_0$, i.e.~a $\sigma$-additive function defined on an algebra of sets (\cref{set:algebra_of_sets}) such that $\mu_0(\emptyset) = 0$. \Cref{lebesgue:outer_measure} can be used to define an outer measure $\mu^*$ in terms of the premeasure $\mu_0$ by replacing intervals with elements from the given algebra of sets. The $\sigma$-algebra generated by this outer measure contains the given algebra of sets and $\mu^*$ restricts to $\mu_0$. This shows that any premeasure can be extended to a genuine measure, uniquely if $\mu_0$ is $\sigma$-finite. Moreover, it can be shown that this measure is complete.
    \end{construct}
...
\subsection{Measurable functions}
    ...
    \begin{property}
        ...
        Mesurability is closed under composition. This turns the collection of measurable spaces and measurable functions into a category $\mathbf{Meas}$. (This notation is also used for the subcategory on \textit{measure spaces} (\cref{lebesgue:measure_preserving}).)
    \end{property}
...
\subsection{Limit operations}
    ...
    \begin{remark}[\difficult{Relation to functional weak convergence}]\index{Stone--\vee{C}ech compactification}
...
\subsection{Simple functions}
    ...
    \newdef{Step function}{\index{step function}\label{lebesgue:step_function}
    ...
    \newdef{Lebesgue integral of simple functions}{\index{Lebesgue!integral}\label{lebesgue:integral_simple_function}
        ...
        \begin{gather}
            \bigintsss_A\varphi\,d\mu := \sum_{i=1}^na_i\mu(A\cap A_i)\,.
        \end{gather}
    ...
    \begin{example}
        ...
        \begin{gather}
            \bigintsss_{\mathbb{R}}\mathbbm{1}_{\mathbb{Q}}\,d\lambda = 1\times\lambda(\mathbb{Q}) + 0\times\lambda(\mathbb{R}\backslash\mathbb{Q}) = 0\,,
        \end{gather}
        where the measure of the rational numbers is 0 because it is a countable set (\cref{lebesgue:countable_set_is_null}).
    \end{example}
...
\subsection{Measurable functions}
    ...
    \newdef{Integral for nonnegative functions}{\index{Lebesgue!integral}\label{lebesgue:integral}
        ...
        \begin{gather}
            \bigintsss_Af\,d\mu := \sup\left\{\bigintsss_A\varphi\,d\mu\,\middle\vert\,\varphi\text{ a simple function such that }\varphi\leq f\right\}\,.
        \end{gather}
        This integral is always nonnegative.
    }

    \begin{formula}\label{lebesgue:domain_change}
        The following equality allows to change the domain of integrals:
        \begin{gather}
            \bigintsss_Af\,d\mu = \int_Xf\mathbbm{1}_A\,d\mu\,.
        \end{gather}
    \end{formula}
...
\subsection{Integrable functions}
    ...
    \newdef{Integrable function}{\index{integrable}\label{lebesgue:integrable_function}
        ...
        \begin{gather}
            \bigintsss_Af\,d\mu := \int_Af^+\,d\mu - \int_Af^-\,d\mu\,.
        \end{gather}
    ...
    \begin{property}[Absolute integrability]\label{lebesgue:absolute_integrability}
        ...
        \begin{gather}
            \bigintsss_A|f|\,d\mu = \bigintsss_Af^+\,d\mu + \bigintsss_Af^-\,d\mu\,.
        \end{gather}
    \end{property}
    \begin{property}
...
\subsection{Convergence theorems}
    ...
    \begin{theorem}[Fatou's lemma]\index{Fatou}\label{lebesgue:fatous_lemma}
        ...
        \begin{gather}
            \bigintsss_A\left(\liminf_{n\rightarrow\infty}f_n\right)\,d\mu \leq \liminf_{n\rightarrow\infty}\bigintsss_Af_n\,d\mu
        \end{gather}
    \end{theorem}
    \begin{theorem}[Monotone convergence]\index{monotone!convergence theorem}\label{lebesgue:monotone_convergence_theorem}
        ...
        \begin{gather}
            \bigintsss_Af\,d\mu = \lim_{n\rightarrow\infty}\bigintsss_Af_n\,d\mu\,.
        \end{gather}
    \end{theorem}
    ...
    \begin{property}
        Let $\seq{f}$ be a sequence of nonnegative measurable functions
        \begin{gather}
            \bigintsss_A\sum_{n=1}^{+\infty}f_n\,d\mu = \sum_{n=1}^{+\infty}\bigintsss_Af_n\,d\mu\,.
        \end{gather}
    ...
    \begin{theorem}[Beppo Levi\footnotemark]\index{Beppo Levi}\label{lebesgue:beppo_levi}
        ...
        \begin{gather}
            \bigintsss_A\sum_{i=1}^{+\infty}f_n\,d\mu = \sum_{i=1}^{+\infty}\bigintsss_Af_n\,d\mu\,.
        \end{gather}
    \end{theorem}
    ...
    \begin{theorem}[Riemann--Lebesgue lemma]\index{Riemann--Lebesgue lemma}\label{lebesgue:riemann_lebesue_lemma}
        ...
        \begin{gather}
            s_k=\bigintsss_{\mathbb{R}}f(x)\sin(kx)\,dx
        \end{gather}
        and
        \begin{gather}
            c_k=\bigintsss_{\mathbb{R}}f(x)\cos(kx)\,dx
        \end{gather}
        both converge to 0.
    \end{theorem}
    ...
    \begin{theorem}[Birkhoff ergodicity]\index{ergodic!theorem}\index{Birkhoff|seealso{ergodic}}\label{lebesgue:ergodic}
        ...
        \begin{gather}
            \lim_{n\rightarrow\infty}\frac{1}{n+1}\sum_{t=0}^nf\bigl(T^n(x)\bigr) = \bigintsss_Xf\,d\mu\,.
        \end{gather}
    \end{theorem}
...
\subsection{Relation to the Riemann integral}
    ...
    \begin{property}
        If $f\geq0$ and the improper Riemann integral (\cref{calculus:improper_integral}) exists, the Lebesgue integral exists and the two integrals coincide. Note that positivity is necessary here. Because the Lebesgue integral is absolute (\cref{lebesgue:absolute_integrability}), positive and negative parts cannot cancel (Lebesgue integrals can never be conditionally convergent).
    \end{property}

    The following definition should be compared to \cref{lebesgue:indicator_function} and \cref{distribution:dirac_delta}.
...
\subsection{Distance}\index{distance}
    ...
    \begin{property}
        ...
        \begin{gather}
            ...
            \|f\|_1 := \bigintsss_X|f|\,d\mu\,.
        \end{gather}
        In particular,
        \begin{gather}
            \bigintsss_X|f|\,d\mu=0\implies f=0\text{ a.e.}
        \end{gather}
    \end{property}
...
\subsection{Hilbert space \texorpdfstring{$L^2$}{L2}}\label{section:hilbert_space}
    ...
    \begin{property}\label{lebesgue:L2_hilbert_space}
        ...
        \begin{gather}
            ...
            \|f\|_2 := \left(\bigintsss_X|f|^2\,d\mu\right)^{1/2}\,.
        \end{gather}
        This norm is induced by the following inner product:
        \begin{gather}
            \label{lebesgue:L2_inner_product}
            \langle f\mid g \rangle := \bigintsss_X\overline{f}g\,d\mu\,.
        \end{gather}
    \end{property}

    \begin{formula}[Cauchy--Schwarz inequality]\index{Cauchy--Schwarz}\label{lebesgue:schwarz_inequality}
        Let $f,g\in L^2(X,\mathbb{C})$. \Cref{lebesgue:holders_inequality} implies that $fg\in L^1(X,\mathbb{C})$ and
        \begin{gather}
            \left|\bigintsss\overline{f}g\,d\mu\,\right|\leq\|fg\|_1\leq\|f\|_2\|g\|_2\,.
        \end{gather}
    \end{formula}
...
\subsection{\texorpdfstring{$L^p$}{Lp}-spaces}
    ...
    \begin{formula}
        ...
        \begin{gather}
            ...
            \|f\|_p := \left(\bigintsss_X|f|^p\,d\mu\right)^{1/p}\,.
        \end{gather}
    \end{formula}
...
\subsection{Construction}
    ...
    \begin{formula}[Product measure]\index{measure}
        ...
        \begin{gather}
            \mu(A) = \bigintsss_{X_2}\mu_1(A_{x_2})\,d\mu_2(x_2)\,.
        \end{gather}
    \end{formula}
    \begin{property}
        ...
        \begin{gather}
            \bigintsss_{X_2}\mu_1(A_{x_2})\,d\mu_2(x_2) = \bigintsss_{X_1}\mu_2(A_{x_1})\,d\mu_1(x_1)\,.
        \end{gather}
...
\subsection{Fubini's theorem}
    ...
    \begin{theorem}[Tonelli]\index{Tonelli}\label{lebesgue:tonelli_theorem}
        ...
        \begin{align}
            \bigintsss_{X_1\times X_2}f\,d\mu &= \bigintsss_{X_1}\left(\bigintsss_{X_2}f(x_1,x_2)d\mu_2(x_2)\right)d\mu_1(x_1)\nonumber\\
            &= \bigintsss_{X_2}\left(\bigintsss_{X_1}f(x_1,x_2)d\mu_1(x_1)\right)d\mu_2(x_2)\,.
        \end{align}
    \end{theorem}
    ...
    \begin{result}[Fubini]\index{Fubini}
        ...
        \begin{gather}
            x_1\mapsto\bigintsss_{X_2}f(x_1,x_2)\,d\mu_2(x_2)
        \end{gather}
        and
        \begin{gather}
            x_2\mapsto\bigintsss_{X_1}f(x_1,x_2)\,d\mu_1(x_1)
        \end{gather}
...
\section{Radon--Nikodym theorem}\index{Radon--Nikodym}\label{section:Radon-Nikodym}
    ...
    \begin{theorem}[Radon--Nikodym theorem]\label{lebesgue:radon_nikodym}
...
\section{Lebesgue--Stieltjes integral}\index{Lebesgue--Stieltjes}
    ...
    An immediate extension of \cref{lebesgue:outer_measure} gives the outer measure associated to $F$.
...
\section{Signed measures}
    ...
    \newdef{Signed measure}{\index{measure!signed}
        ...
        \begin{enumerate}
            ...
            \item\textbf{$\sigma$-additivity}: $\forall i\neq j:E_i\cap E_j=\emptyset\implies\mu\left(\bigcup_{n=1}^\infty E_n\right) = \sum_{i=n}^{+\infty}\mu(E_n)$.
        \end{enumerate}
        Note that these requirements are the same as for an ordinary measure (\cref{lebesgue:measure}), except that now the function is allowed to become negative. The function is, however, not allowed to attain $-\infty$ to exclude undefined expressions such as $\infty-\infty$.
    }
    \begin{remark}
    ...
    \newdef{Integral with respect to a signed measure}{\index{integral!signed measure}
        ...
        \begin{gather}
            \bigintsss_Af\,d\mu := \bigintsss_Af\,d\mu^+ - \bigintsss_Af\,d\mu^-\,.
        \end{gather}
    }

    \newdef{Lebesgue--Stieltjes signed measure}{\index{Lebesgue--Stieltjes}
    ...
    \begin{theorem}[Fundamental theorem of calculus]\index{fundamental theorem!of calculus}
        ...
        \begin{gather}
            F(x) - F(a) = \mu_F([a,x]) = \bigintsss_a^xF'(t)\,dt\,.
        \end{gather}
    \end{theorem}
    \begin{result}
...
\section{Bochner integral}\index{Bochner!integral}
    ...
    In this section, the Lebesgue integral is generalized to functions taking values in general \textit{Banach space} (see \cref{section:banach}). Since addition still makes sense in these space, \cref{lebesgue:integral_simple_function} can also still be used.
    \newdef{Bochner integral of simple functions}{\index{Lebesgue!integral}\label{lebesgue:bochner_integral_simple_function}
    ...
    \newdef{Bochner integrability}{
        ...
        \begin{gather}
            \lim_{n\rightarrow\infty}\bigintsss_X\|f-\varphi_n\|_V\,d\mu=0\,.
        \end{gather}
        The Bochner integral of such a function is given by
        \begin{gather}
            \bigintsss_Xf\,d\mu:=\lim_{n\rightarrow\infty}\bigintsss_X\varphi_n\,d\mu\,.
        \end{gather}
    }
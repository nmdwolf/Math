...
\section{Lebesgue--Stieltjes integral}\index{Lebesgue--Stieltjes}
    ...
    \begin{remark}[Bounded variation]\label{measure:bounded_variation_integral}
        Note that the Lebesgue--Stieltjes integral can be generalized to functions of (locally) bounded variation, since such functions can be decomposed as the difference of two increasing functions on any interval.
    \end{remark}

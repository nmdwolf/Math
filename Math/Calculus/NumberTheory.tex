...
\section{Algebraic number theory}
    ...
    Lagrange's theorem can also be restated in terms of power series. Consider the \textbf{Jacobi $\theta$-function}\index{Jacobi!$\theta$-function}:\footnote{This function is often generalized by including a factor $\eta^k$.}
    \begin{gather}

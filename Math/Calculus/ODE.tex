...
\subsection{General solution}
    ...
    \newformula{Abel's identity}{\index{Abel}\label{ode:abels_identity}
        ...
        \begin{gather}
            W(x) = W(x_0)\exp\left(-\bigintsss_{x_0}^xa(x')\,dx'\right)\,.
        \end{gather}
    }
...
\section{Sturm--Liouville theory}\index{Sturm--Liouville theory}
    ...
    \newprop{Self-adjoint form}{
        ...
        \begin{gather*}
            p(x) := \exp\left(\bigintsss\frac{a_1(x)}{a_2(x)}\,dx\right) \qquad\text{and}\qquad g(x) := \frac{a_0(x)}{a_2(x)}\exp\left(\bigintsss\frac{a_1(x)}{a_2(x)}\,dx\right)\,.
        \end{gather*}
    }

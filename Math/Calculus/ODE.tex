\chapter{Ordinary differential equations}\label{chapter:ODE}
...
\subsection{General solution}
    ...
    \newformula{Abel's identity}{\index{Abel!identity}\label{ode:abels_identity}
        ...
        \end{gather}
        where $a:\mathbb{R}\rightarrow\mathbb{R}$ is the coefficient for the $f'$-term in \cref{ode:second_order_ODE}.
    }
    ...
    \begin{formula}[Reduction of order]\label{ode:second_order_general_solution}

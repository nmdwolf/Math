...
\section{Sobolev spaces}
    ...
    Using the theory of $L^p$-spaces and distributions (\cref{chapter:measure,chapter:distributions}), one can define an important class of function spaces that are ubiquitous in the field of PDEs (and beyond).

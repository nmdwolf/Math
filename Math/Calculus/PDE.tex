...
\section{Important examples}
    ...
    \begin{example}[Laplace equation]\index{Laplace!equation}\index{harmonic!function}\label{pde:laplace_equation}
        \begin{gather}
    ...
    \todo{ADD (Helmholtz, Poisson, heat, ...)}
...
\section{First order PDE}
    ...
    \newformula{Characteristic curve}{\index{Pfaff!system}

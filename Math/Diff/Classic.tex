...
\section{Curves}
    ...
    \newdef{Regular curve}{\index{regular!curve}
        Let $c:I\rightarrow\mathbb{R}^n$ be a curve. It is said to be regular at $t\in I$ if $\deriv{c}{t}\neq0$. (This is generalized in \ref{manifold:regular_point}.)
    }
...
\subsection{Arc length}
    ...
    \newdef{Natural parameter}{\index{natural!parameter}\label{diff:natural_parameter}
        Let $c:I\rightarrow\mathbb{R}^n$ be a curve. The parametrization is said to be natural if
        \begin{gather}

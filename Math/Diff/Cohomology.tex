...
\subsection{Cohomology with compact support}\index{cohomology!compact support}\label{section:compact_cohomology}
    ...
    \newdef{Poincar\'e dual}{
        ...
        \begin{gather}
            \bigintsss_Si^*\omega = \bigintsss_M\omega\wedge\eta_S
        \end{gather}
        ...
        \begin{itemize}
            ...
            \begin{gather}
                \bigintsss_Si^*\omega = \bigintsss_M\omega\wedge\eta'_S
            \end{gather}
    ...
    \begin{formula}[Projection formula]\index{projection!formula}
        ...
        \begin{gather}
            \bigintsss_E\pi^*\phi\wedge\omega = \bigintsss_M\phi\wedge\pi_*\omega\,.
        \end{gather}
    \end{formula}

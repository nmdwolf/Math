...
\section{Complex structures}
    ...
    \begin{theorem}[Oka coherence theorem]\index{Oka coherence theorem}
        The structure sheaf, the sheaf of holomorphic functions, of a complex manifold is coherent \ref{sheaf:coherent}.
    \end{theorem}
    ...
    \newdef{Stein manifold}{\index{Stein manifold}\index{convex!holomorphically}\index{separable!holomorphically}
        ...
        \begin{enumerate}
            ...
            \begin{gather}
                \overline{K} := \big\{z\in M\,\big\vert\,\forall f\in\mathcal{O}(M):|f(z)|\leq\sup_{z'\in K}|f(z')|\big\}
            \end{gather}
            is compact.
    ...
    The following type of cover resembles that of Definition \ref{manifold:good_cover} and Property \ref{manifold:good_cover_existence}:
    ...
    \begin{remark}[Oka manifolds]\index{Oka!manifold}
        This principle has a more general homotopical/model-theoretic (Chapter \ref{chapter:model_theory}) formulation. There exists a class of complex manifolds, the Oka manifolds, such that the inclusion
        \begin{gather}
    ...
    \begin{theorem}[Cartan's theorem A]\index{Cartan}
        Every coherent sheaf \ref{sheaf:coherent} on a Stein manifold is spanned by its global sections.
    \end{theorem}

...
\subsection{Parallel transport}
    ...
    \begin{example}
        ...
        \begin{gather}
            g(t) = \left[\mathbbm{1} - \int_0^tA(\gamma'(t_1))\,dt_1 + \int_0^t\int_0^{t_1}A(\gamma'(t_1))A(\gamma'(t_2))\,dt_2\,dt_1-\ldots\right]g(0),
        \end{gather}
        ...
        \begin{gather}
            g(t) = \left[\mathbbm{1} - \int_0^t(\gamma'(t_1))\,dt_1 + \frac{1}{2!}\int_0^t\int_0^t\mathcal{T}\Big(A(\gamma'(t_1))A(\gamma'(t_2))\Big)\,dt_2\,dt_1-\ldots\right]g(0).
        \end{gather}
...
\subsection{Exterior covariant derivative}\label{section:exterior_covariant_derivative}
    ...
    \newdef{Exterior covariant derivative}{\index{exterior!covariant derivative}
        ...
        \begin{gather}
            D\theta(v_0,\ldots,v_k) := \dr\theta(v_0^H,\ldots,v_k^H),
        \end{gather}
    ...
    \begin{remark}
        ...
        \begin{gather}
            ...
            D\theta = \dr\theta + \omega\barwedge\theta,
        \end{gather}
    ...
    \begin{construct}[Covariant derivative]\label{bundle:covariant_derivative_associated_bundle}
        ...
        \begin{gather}
            D\phi(X) = \dr\phi(X) + \omega\triangleright\phi(X),
        \end{gather}
        ...
        \begin{gather}
            (\varphi^*D\phi)(Y) = \dr(\varphi^*\phi)(Y) + \varphi^*\omega\triangleright\varphi^*\phi(Y),
        \end{gather}
...
\section{\texorpdfstring{$\mathcal{D}$-geometry $\clubsuit$}{D-geometry}}
    ...
    \newdef{$\mathcal{D}_X$-module}{
        ...
        \begin{enumerate}
            ...
            \item\textbf{Flatness}: $\nabla_{[v,w]}\sigma = [\nabla_v,\nabla_w]\sigma$.
        \end{enumerate}
        If $X$ is \textit{locally free}, i.e.~corresponds to a locally trivial manifold (a bundle), one obtains the algebraic reformulation of a vector bundle with flat connection.
    }
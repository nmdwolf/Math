...
\section{Cartan geometry}\label{section:cartan_geometry}
    ...
    In the first part of this section, a short overview of \textit{Klein}'s \textbf{Erlangen program}, which unifies (and generalizes) Euclidean and non-Euclidean geometries, will be given. In the second part of this section, \textit{Cartan}'s generalization in terms of bundle theory is explained. A reference for this section is~\citet{sharpe_differential_2000}.\index{Erlangen program}

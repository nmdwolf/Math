...
\subsection{Graded manifolds}
    ...
    \begin{formula}[Quantum master equation]
        ...
        \end{gather}
        This equation is called the quantum master equation. Expanding $S$ as a power series in $\hbar$ shows that the constant term satisfies the classical master equation \eqref{hdg:classical_master_equation}.
    \end{formula}

...
\section{Graded manifolds}
    ...
    \newdef{Poisson manifold}{\index{Poisson!manifold}\label{hdg:poisson_manifold}
        ...
        \end{gather}
        It is not hard to check that this operation is graded commutative. As in \cref{section:hamiltonian_vector_fields}, given a symplectic form, a Hamiltonian vector field can be defined for any smooth function $H\in C^\infty(M)$:
        \begin{gather}

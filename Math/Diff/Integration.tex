\section{Integration Theory}\label{section:integration_manifolds}
    ...
    For the theory of measure spaces and Lebesgue integration, see Chapter \ref{chapter:measure}. Further below, integration theory will be generalized from orientable manifolds to nonorientable manifolds. A good introduction for this is \cite{tensor_bundle_calculus}.

\subsection{Orientation and densities}

    One can define an orientation on manifolds by generalizing the situation for vector spaces \ref{vector:orientation}:

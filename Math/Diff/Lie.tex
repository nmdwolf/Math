...
\section{Lie groups}\label{section:lie_groups}
    ...
    \newdef{Lie group}{\index{Lie!group}\label{lie:lie_group}
        A group that is also a differentiable manifold such that both the multiplication and inversion maps are smooth. For complex Lie groups one requires the definition of a \textit{complex manifold} (Chapter \ref{chapter:complex_geometry}).
    }
    \newdef{Lie subgroup}{

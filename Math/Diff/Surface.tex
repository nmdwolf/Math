...
\section{Curves}
    ...
    \newdef{Regular curve}{\index{regular!curve}
        Let $c:I\rightarrow\mathbb{R}^n$ be a curve defined on an interval $I$. It is said to be regular\footnote{This is generalized in Result \ref{manifold:regular_point}.} if $\deriv{c}{t}\neq0$.
    }
...
\section{Surfaces}
    ...
    \newdef{Normal vector}{\index{normal!vector}
        The cross product in the preceding definition is closely related to the normal vector to $\Sigma$ at the point $p(q_0^1,q_0^2)$. The normal vector at the point $p$ is defined as
        \begin{gather}

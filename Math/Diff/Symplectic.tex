...
\section{Symplectic manifolds}
    ...
    \begin{construct}[Liouville one-form\footnotemark]\index{Liouville!form}\index{tautological!form|see{Liouville}}
        \footnotetext{Also known as the \textbf{tautological one-form}.}

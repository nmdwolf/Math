...
\subsection{Morse functions}
    ...
    \end{result}
    \begin{result}
        Let $\gamma$ be an integral curve on $M$ such that $f(\gamma)$ is bounded. The curve is complete and its limits are critical points of $f$. Moreover, the convergence at $t\longrightarrow\pm\infty$ is exponential.
    \end{result}

...
\subsection{\v{C}ech--de Rham complex}\label{section:cech_de_rham}
    ...
    \begin{property}[Exponential sequence]
        ...
        \end{gather}
        Let $(M,\mathcal{O}_M)$ be a \textit{complex manifold} (see \labelref{chapter:complex_geometry}) or a smooth manifold and restrict the above sequence to the real numbers. The exact sequence induces an exact sequence of structure sheaves:
        \begin{gather}

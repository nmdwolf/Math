...
\subsection{Frenet--Serret frame}
    ...
    \newdef{Frenet--Serret frame}{\index{Frenet--Serret frame}\index{comoving}\label{diff:frenet_serret_frame}
        Because the vectors $t(s),n(s)$ and $b(s)$ are mutually orthonormal and linearly independent, they can be used to construct an orthonormal basis. The ordered basis $\bigl\{t(s),n(s),b(s)\bigr\}$ is called the Frenet--Serret frame. This is an example of a \textbf{comoving} frame.
    }

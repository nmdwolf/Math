...
\subsection{Supergeometry}
    ...
    \newdef{Super smooth set}{\index{smooth!set}\index{topos!Dubuc}
        By combining infinitesimal thickenings and superpoints, the category $\symbfsf{SuperFormalCartSp_{diff}}$ is obtained. A sheaf on this category is called a super smooth set. Since \textit{Dubuc} introduced the Cahiers topos, the category of super smooth sets is sometimes called the \textbf{super-Dubuc topos}.
    }

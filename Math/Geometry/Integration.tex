\section{Integration Theory}\label{section:integration_manifolds}
    ...
    For the theory of measure spaces and Lebesgue integration, see \labelref{chapter:measure}. Further below, integration theory will be generalized from orientable manifolds to nonorientable manifolds. A good introduction for this is~\citet{tiee_contravariance_2006}.

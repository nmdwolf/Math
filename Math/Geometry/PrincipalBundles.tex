...
\subsection{Complex bundles}
    ...
    On \textit{complex bundles}, one can always choose $\mathfrak{u}(n)$-valued connection 1-forms, since the structure group can be reduced to $\mathrm{U}(n)$. See \cref{chapter:complex_geometry} for more information.

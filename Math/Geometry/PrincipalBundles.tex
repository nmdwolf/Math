...
\subsection{Torsion}
    ...
    \newdef{Contorsion}{\label{bundle:contorsion}
        Let $\omega$ be a connection 1-form. There exists $\ad(P)$-valued 1-form $\sigma_\omega$ such that $\omega+\sigma_\omega$ is torsion-free. This 1-form is called the contorsion (tensor) of $\omega$.
    }

...
\subsection{Inner product space}
    ...
    \newdef{Adjoint map}{\index{adjoint!Hermitian}\index{Hermitian}\index{self-adjoint}\label{linalgebra:adjoint_operator}
        ...
        \end{gather}
        If $A=A^\dag$, $A$ is said to be \textbf{Hermitian} or \textbf{self-adjoint}. (In \labelref{chapter:functional}, a distinction will be made between these two notions.)
    }
...
\subsection{Orthogonality}\label{section:orthogonality}
    ...
    By specializing \cref{linalgebra:dual_complement}, one obtains the more classical notion of orthogonal complements.

...
\subsection{2-sheafs}
    ...
    For $\infty$-sheaves the full \v{C}ech nerve will be used. However, for 2-sheaves and in particular stacks only use its 3-coskeleton is necessary. The extra information will encode the \textit{cocycle condition} known for example from the study of fibre bundles (Equation \eqref{bundle:G_cocycle_condition}).

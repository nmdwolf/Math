...
\subsection{2-sheafs}
    ...
    For $\infty$-sheaves the full \v{C}ech nerve will be used. However, for 2-sheaves and in particular stacks only use its 3-coskeleton is necessary. The extra information will encode the \textit{cocycle condition} known for example from the study of fibre bundles (see Equation \eqref{bundle:G_cocycle_condition}).
...
\section{Cohesion}\index{cohesion}
    ...
    \newdef{Locally-connected topos}{\index{locally!connected topos}
    ...
    \begin{property}[Cohesive modalities]\index{flat!modality}\index{sharp!modality}\index{shape!modality}\index{discrete!object}

...
\subsection{Grothendieck topologies}
    ...
    The characterization of geometric embeddings and, hence, of Grothendieck topoi in terms of localizations (\cref{topos:characterization_embedding}) is equivalent to a definition in terms of reflections (this is due to \indexauthor{Street}).
    \begin{result}

...
\subsection{Correlation}
    ...
    \newdef{Autocorrelation function}{\index{autocorrelation}\index{correlation|seealso{autocorrelation}}
        Consider a stochastic process $\seq{X}$. The autocovariance (resp.~autocorrelation) function of this process is defined as the covariance (resp.~autocorrelation) function of the random variables $\seq{X}$.
    }

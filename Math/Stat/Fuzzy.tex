\chapter{\difficult{Fuzzy Sets \& Imprecise Probabilities}}
    ...
    The main reference for the basics on fuzzy sets is the initial paper~\citet{zadeh_fuzzy_1965}. For the basics of (ordered) sets, see \cref{section:ordered_sets} at the beginning of this compendium. The section on imprecise probabilities is mainly based on~\citet{augustin_introduction_2014}.
...
\section{Fuzzy sets}
    ...
    The following definition is an immediate generalization of \cref{set:relation}.
...
\section{Fuzzy measure theory}
    ...
    In this section some of the content of \cref{chapter:measure} is generalized to fuzzy set theory. Unless explicitly stated, all concepts will be defined over a general measurable space $(X,\Sigma)$.

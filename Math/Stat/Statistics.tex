...
\subsection{Moment estimators}
    ...
    \begin{property}
        Let $\{x_i\}_{i\leq n}$ be a data set taking values in $\mathbb{R}_+$.
        \begin{gather}
...
\subsection{Least squares estimation}
    ...
    \newmethod{Binned least squares}{$ $
        \begin{enumerate}
            \item $n\in\mathbb{N}$ i.i.d.~events with density $f(X;a)$ divided in $N_B\in\mathbb{N}$ bins, where the interval $j$ is centered on the value $x_j$, has a width $W_j$ and contains $n_j\in\mathbb{N}$ events.

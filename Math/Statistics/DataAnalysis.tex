...
\section{Time series analysis}
    ...
    \newdef{Time series}{\index{time series}
        An $\mathbb{N}$- or $\mathbb{Z}$-indexed stochastic process (\cref{chapter:stochastic_calculus}). Since $\mathbb{N}$ and $\mathbb{Z}$ are isomorphic, the two conventions for time series will be used interchangeably.
    }

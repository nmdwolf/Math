...
\subsection{Kernel methods}\label{data:kernel_methods}
    ...
    This section will introduce the mathematics of kernel methods. This mainly involves the language of Hilbert spaces (\labelref{chapter:functional} for a refresher).

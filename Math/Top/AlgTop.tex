...
\subsection{Homotopy groups}
    ...
    \newdef{Semilocally simply connected}{
        A topological space is said to be semi-locally simply connected if every point admits a neighbourhood $U$ such that every loop in $U$ can be contracted to a point.
    }
...
\subsection{Simplicial homology}\index{homology!simplicial}
    ...
    \begin{remark}[Hauptvermutung $\clubsuit$]\index{Hauptvermutung}

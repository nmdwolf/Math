...
\subsection{Applications}
    ...
    \begin{construct}[Chern character]\index{Chern!character}\label{k:chern_character}
        ...
        \end{gather}
        where $\nabla^E,\nabla^F$ are connections on $E$ and $F$, respectively. This morphism is a ring morphism (with respect to Whitney sums and tensor products). For relative $K$-theory classes $[E,F,\alpha]\in K(M,N)$ one should pick connections that are related as $\nabla^E|_N=\alpha^*(\nabla^F|_N)$.
    \end{construct}
    ...
    \begin{property}[$K\!K$-theory]\label{k:topological_kk_theory}
        ...
        \begin{align}
            K\!K(\mathbb{C},C(X))&\cong K^0(X)\,,\\
            K\!K(C(\mathbb{R}),C(X))&\cong K^1(X).
        \end{align}
    \end{property}
...
\section{\texorpdfstring{Differential $K$-theory}{Differential K-theory}}
    ...
    \newdef{Simons-Sullivan mdodel}{\index{Simons-Sullivan}
        ...
        \begin{gather}
            \widehat{K}^0(M) := G(\mathrm{Struct}(M)).
        \end{gather}
    }
...
\section{\texorpdfstring{Operator $K$-theory}{Operator K-theory}}\index{K-theory!operator}
    ...
    \begin{property}[$K\!K$-theory]
        If $A$ is a $C^*$-algebra, then operator $K$-theory and Kasparov $K$-theory \ref{operators:kk_theory} are related as follows:
        \begin{align}
            K\!K(\mathbb{C},A)&\cong K_0(A)\,,\\
            K\!K(C(\mathbb{R}),A)&\cong K_1(A).
        \end{align}
        Property \ref{k:topological_kk_theory} is then simply a consequence of this isomorphism by Property \ref{k:serre_swan}.
    \end{property}
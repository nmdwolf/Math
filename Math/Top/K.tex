...
\subsection{Introduction}
    ...
    \begin{property}
        Property \ref{bundle:hausdorff} implies that every virtual bundle has a representant of the form $[E]-[X\times\mathbb{R}^n]$ for some vector bundle $E$ and integer $n\in\mathbb{N}$.
    \end{property}
    ...
    \begin{adefinition}
        The reduced $K$-theory $\widetilde{K}^0(X)$ can equivalently be defined as follows. Consider the stable isomorphism classes \ref{bundle:stable_isomorphism} of vector bundles over $X$. Under Whitney sums these form a commutative group $(\mathrm{Vect}(X)/\sim_\text{stable},\oplus)$, which is (naturally) isomorphic to $\widetilde{K}^0(X)$.
    \end{adefinition}
...
\subsection{Classification}
    ...
    \end{remark}
    \begin{remark}[Kuiper's theorem]\label{k:kuiper_remark}
...
\subsection{Negative degree}
    ...
    \newdef{$K^{-n}$}{\label{k:lower_groups}
        ...
        \begin{gather}
            ...
            K^{-n}(X,Y) := K^0\big((X\backslash Y)\times\mathbb{R}^n\big).
        \end{gather}
        ...
        \begin{gather}
            ...
            K^{-n}(X,Y)\cong\widetilde{K}^0\big(\Sigma^n(X/Y)\big)\,,
        \end{gather}
...
\section{\texorpdfstring{Twisted $K$-theory}{Twisted K-theory}}\index{K-theory!twisted}
    ...
    \newdef{Twisted $K$-theory}{
        ...
        \begin{gather}
            K^0_\alpha(M) := \Gamma\big(\mathrm{Fred}(P)\big)/\sim.
        \end{gather}
    }
...
\section{\texorpdfstring{Differential $K$-theory}{Differential K-theory}}
    ...
    \newdef{Simons-Sullivan model}{\index{Simons-Sullivan}
...
\section{\texorpdfstring{Operator $K$-theory}{Operator K-theory}}\index{K-theory!operator}
    ...
    \begin{property}[$K\!K$-theory]
        ...
        \begin{align}
            ...
            K\!K\big(C(\mathbb{R}),A\big)&\cong K_1(A).
        \end{align}

...
\section{Examples}
    ...
    \begin{property}[Projections determine convergence]\label{metric:projection}
        ...
        \end{gather}
        A sequence in a product metric space $M$ converges if and only if every component $(\pr_j(x_n))_{n\in\mathbb{N}}$ converges in $(M_j,d_j)$.
    \end{property}
...
\subsection{Convex metric spaces}
    ...
    \newdef{Hyperconvex space}{\index{hyper-!convex}\index{Helly poroperty}

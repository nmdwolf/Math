...
\subsection{Morphisms}
    ...
    \begin{remark}[Finite \'etale covering]\index{etale!covering}
        When a finite \'etale morphism $f:X\rightarrow Y$ exists, $X$ is sometimes called a \textbf{finite \'etale cover(ing)} of $Y$. The full subcategory of the slice category $\symbfsf{Sch}/_Y$ on finite \'etale coverings is often denoted by $\symbfsf{FEt}_Y$.
    \end{remark}

...
\section{\texorpdfstring{Twisted $K$-theory}{Twisted K-theory}}\index{K-theory!twisted}\label{section:twisted_k_theory}
    ...
    The most straightforward way to introduce twisted $K$-theory is similar to that of twisted de Rham theory (\cref{bundle:twisted_de_rham}). Namely, by introducing a degree-3 integral cohomology class or, equivalently, by twisting by a $\mathrm{U}(1)$-\textit{bundle gerbe} (see \labelref{chapter:hdg}).

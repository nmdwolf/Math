...
\section{Banach spaces}
    ...
    \newdef{Bracket}{\index{bracket}\label{functional:bracket}
        Let $X$ be a set and consider a normed subset $(\mathcal{F},\|\cdot\|)$ of $X^\mathbb{R}$. For every two functions $u,l:X\rightarrow\mathbb{R}$, the bracket $[l,u]$ on $\mathcal{F}$ consists of all functions $f\in\mathcal{F}$ such that
        \begin{gather}
            \forall x\in X:l(x)\leq f(x)\leq u(x).
        \end{gather}
        A $\varepsilon$-bracket, for $\varepsilon>0$, is a bracket $[l,u]$ such that $\|u-l\|<\varepsilon$. The \textbf{bracketing number} $N_{[\,]}(\varepsilon,\mathcal{F},\|\cdot\|)$ is defined as the least number of $\varepsilon$-brackets needed to cover $\mathcal{F}$.
    }
...
\section{Hilbert spaces}
    ...
    \begin{example}
        ...
        \begin{gather}
            ...
            \langle f|g \rangle_\phi := \int_a^b\overline{f(x)}g(x)\phi(x)\,dx.
        \end{gather}
    \end{example}
...
\subsection{Generalized Fourier series}
    ...
    \newdef{Complete set}{\index{complete!set}\index{Hilbert!basis}
        ...
        \begin{gather}
            v = \sum_{i\in I}\langle e_i|v \rangle e_i.
        \end{gather}
    ...
    \begin{adefinition}
        ...
        \begin{gather}
            \forall v_i\in S:\langle v_i|w \rangle = 0.
        \end{gather}
    \end{adefinition}
...
\subsection{Orthogonality and projections}
    ...
    \end{theorem}
    \remark{An equivalent definition for this projection is the vector $v'$ satisfying
    \begin{gather}
    ...
    \newdef{Trace}{\index{trace}\label{functional:trace}
        ...
        \begin{gather}
            \tr(S) := \sum_{i\in I}\langle e_i|Se_i \rangle.
        \end{gather}
    }
...
\subsection{Locally convex spaces}
    ...
    \newdef{G\^ateaux derivative}{\index{smooth!function}\index{derivative!G\^ateaux}\index{derivative!Michal-Bastiani}\label{functional:gateaux}
        ...
        \begin{gather}
            df(v;h) := \lim_{t\rightarrow0}\frac{f(v+th) - f(v)}{t}=\left.\deriv{}{t}f(v+th)\right|_{t=0}.
        \end{gather}
        ...
        \begin{gather}
            d^{(k)}f(v;h_1\otimes\cdots\otimes h_k) := \left.\mderiv{k}{}{t}f(v+th_1+\cdots+th_k)\right|_{t=0}.
        \end{gather}
    }
    ...
    \end{theorem}
    The following theorem gives an extension
    \begin{theorem}[Choquet]\index{Choquet}\label{functional:choquet}
        ...
        \begin{gather}
            \mu:C\rightarrow\mathbb{P}(\mathrm{Extr}(C)):c\mapsto\mu_c
        \end{gather}
        such that
        \begin{gather}
    ...
    \newdef{Strong topology}{\index{topology!strong}\index{topology!polar}
        Let $X$ be a topological vector space. The strong topology (or \textbf{topology of uniform convergence on bounded sets}) on $X'^*$ is the locally convex topology defined by the seminorms
        \begin{gather}
            p_B(\lambda) := \sup_{x\in B}|\lambda(x)|,
        \end{gather}
        where $B$ is a bounded set of $X$. This is an example of a \textit{polar topology}. A dual space equipped with the strong topology is often called the \textbf{strong dual}.
    }
...
\subsection{Tensor products}\index{tensor product!of vector spaces}
    ...
    \newdef{Tensor products of locally convex spaces}{
        ...
        The injective tensor product can be extended to locally convex spaces as follows. Equip the dual $V'$ with the finest locally convex topology that coincides with the weak topology on equicontinuous sets \ref{metric:equicontinuity}. The, equip the space of continuous linear maps $L_\mathrm{cont}(V',W)$ with the topology of uniform convergence on compact equicontinuous sets. $V\otimes W$ with the induced topology, as a subset of $L_\mathrm{cont}(V',W)$, is called the injective tensor product $V\otimes_\varepsilon W$.
    }
    \begin{adefinition}
...
\subsection{Compact operators}
    ...
    \begin{property}
        ...
        \begin{gather}
            \mathrm{ind}:\pi_0(\mathfrak{F}(\mathcal{H}))\rightarrow\mathbb{Z}
        \end{gather}
        ...
        \end{itemize}
        This theorem is generalized in $K$-theory by the Atiyah-J\"anich theorem \ref{k:atiyah_janich}.
    \end{property}
...
\subsection{Spectral theorem}\label{section:PVM}
    ...
    \newdef{Measurable functional calculus}{\index{functional!calculus}
        ...
        \begin{enumerate}
            ...
            \item\textbf{Involutivity}: $\Phi(f^*)=\overline{\Phi(f)}$.
    ...
    \begin{property}
        ...
        \end{gather}
        is a projection-valued measure. Conversely, every proejction-valued measure $P$ gives rise to a measurable functional calculus $\Phi$ such that $P=P_\Phi$.
    \end{property}

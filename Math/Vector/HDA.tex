...
\subsection{\texorpdfstring{Lie $n$-algebras}{Lie n-algebras}}\label{section:higher_lie_structures}
    ...
    \begin{remark}[Curvature]\index{curvature}
        ...
        \end{gather}
        This terminology stems from the situation where $l_1$ is identified with the exterior covariant derivative on an associated vector bundle (Formula \ref{bundle:curvature_associated_bundles}).
    \end{remark}
    ...
    \newdef{Maurer-Cartan element}{\index{Maurer-Cartan!equation}
        ...
        \end{gather}
        For dg-Lie algebras this reduces to the ordinary Maurer-Cartan equation \ref{bundle:mc_equation}:
        \begin{gather}
            da + \frac{1}{2}[a,a] = 0.
        \end{gather}

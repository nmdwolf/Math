...
\section{Algebras}
    ...
    \begin{example}[Frobenius algebra]\index{Frobenius!algebra}\label{linalgebra:frobenius}
        ...
        \begin{gather}
            \eta(ab,c)=\eta(a,bc)\,.
        \end{gather}
        Equivalently, an associative algebra $(A,\mu)$ equipped with a linear form $\varepsilon:A\rightarrow K$ such that $\varepsilon\circ\mu$ is nondegenerate.\footnote{A third equivalent definition is given in \cref{qa:frobenius}.}

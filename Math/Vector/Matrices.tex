...
\subsection{Characteristic polynomial}
    ...
    \end{theorem}
    \begin{result}
        From Property \ref{algebra:minimal_polynomial_divisor} and the Cayley-Hamilton theorem it follows that the minimal polynomial $\mu_f$ is a divisor of the characteristic polynomial $\chi_f$.
    \end{result}

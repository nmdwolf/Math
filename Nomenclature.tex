...
\nomenclature[S_Tan]{$T^n$}{standard $n$-torus ($n$-fold Cartesian product of $S^1$)}
\nomenclature[S_Dn]{$D^n$}{standard $n$-disk}
\nomenclature[S_Apowerseries]{$A[[x]]$}{ring of (formal) power series in $x$ with coefficients in $A$}
\nomenclature[S_Alaurentseries]{$A((x))$}{ring of (formal) Laurent series in $x$ with coefficients in $A$}

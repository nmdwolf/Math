        ...
        \begin{mdframed}[roundcorner=10pt, linecolor=blue, linewidth=1pt]
            \begin{proof}[Proof based on the principle of least action]
                ...
                \begin{gather}
                    ...
                    I[q] := \int_{t_1}^{t_2}L\big(q(t),\dot{q}(t),t\big)\,dt.
                \end{gather}
                ...
                \begin{gather}
                    ...
                    I(\alpha) = \int_{t_1}^{t_2}L\big(q(t,\alpha),\dot{q}(t,\alpha),t\big)\,dt.
                \end{gather}
...
\section{Hamilton-Jacobi equation}
    ...
    \newformula{Hamilton-Jacobi equation}{\index{Hamilton-Jacobi equation}\index{Hamilton!principal function}
        ...
        \begin{align*}
            ...
            Q^i &=\pderiv{S}{P_i}\,,
        \end{align*}
        and \[K = H + \pderiv{S}{t}.\] Choosing the new Hamiltonian function $K$ to be 0 (this function is sometimes called the \textbf{Kamiltonian}) gives the Hamilton-Jacobi equation:
        \begin{gather}
...
\subsection{Liouville's theorem}
    ...
    \begin{formula}[Liouville's lemma]
        Consider a phase space volume element $dV_0$ moving along a path $\big(q(t),\dot{q}(t)\big)\equiv x(t)$. The Jacobian $J\big(x(t)\big)$ associated with this motion is given by
        \begin{gather}
...
\subsection{Contact structure}
    ...
    \begin{gather}
        \alpha := p_i\dr q^i - H\dr t \equiv\omega - H\dr t.
    \end{gather}

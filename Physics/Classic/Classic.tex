...
\subsection{Linear motion}
    ...
    \newdef{Work}{\index{work}\label{classic:work}
        ...
        \begin{gather}
            W := \bigintsss_\gamma\vector{F}\cdot d\vector{l}\,.
        \end{gather}
    }
    \newdef{Conservative force}{\index{conservative!force}
        ...
        \end{gather}
        The Kelvin--Stokes theorem~\ref{vector:kelvin_stokes_theorem} together with \cref{vector:rotor_of_gradient} allows to rewrite the conservative force as the gradient of a scalar field:
        \begin{gather}
...
\subsection{Rotational motion}
    ...
    \newdef{Moment of inertia}{\index{inertia}\label{classic:moment_of_inertia}
        ...
        \begin{gather}
            ...
            \mathcal{I} := \bigintsss_V\rho(\vector{r})\left(r^2\mathbbm{1} - \vector{r}\otimes\vector{r}\right)\,dV\,.
        \end{gather}
    }
    ...
    \newdef{Principal axes of inertia}{\index{principal!axis}
        Let $I$ be the matrix of inertia, i.e.~the matrix associated with the inertia tensor~\eqref{classic:inertia_tensor}. This is a real symmetric matrix and, by \cref{linalgebra:diagonalizable_hermitian}, admits an eigendecomposition of the form
        \begin{gather}
            I = Q\Lambda Q^T\,.
        \end{gather}
...
\subsection{Action}
    ...
    \newdef{Conjugate momentum}{\index{momentum!conjugate}\label{lagrange:conjugate_momentum}
        \begin{gather}
    ...
    \begin{notation}\label{lagrange:notational_convention_1}
        ...
        \end{gather}
    \end{notation}
    \newdef{Action}{\index{action}\label{lagrange:action}
        ...
        \begin{gather}
            S[q] := \bigintsss_{t_1}^{t_2}L(q,\dot{q},t)\,dt\,.
        \end{gather}
    }
...
\subsection{Kepler problem}\index{Kepler!problem}\label{section:kepler}
    ...
    \newdef{Laplace--Runge--Lenz vector}{\index{Laplace--Runge--Lenz vector}\label{classic:lrl_vector}
        ...
        Before explaining the symmetry itself, the associated Noether charge, the Laplace--Runge--Lenz vector, is given:
        \begin{gather}
...
\section{Hamiltonian mechanics}
    ...
    \newformula{Hamilton's equations}{\index{Hamilton!equations}\label{lagrange:hamilton_equations}
        Inserting the above definition in the action (\cref{lagrange:action}) and applying the variational principle results in the following equations:
        \begin{align}
...
\section{Hamilton-Jacobi equation}
    ...
    \newdef{Canonical transformations}{\index{canonical!transformation}\label{lagrange:canonical_transformation}
        A transformation that leaves the Hamiltonian equations of motion unchanged. This means that the transformation leaves the action invariant up to a constant or, equivalently, they leave the Lagrangian invariant up to a complete time-derivative:
        \begin{gather}
...
\subsection{Phase space}
    ...
    \newdef{Rotation}{\index{rotation}
        ...
        @@ CORRECT (for an ordinary rotation in spherical coordinates this indeed holds, however, for rotation in Cartesian coordinates this fails) @@
    }
    ...
    \newdef{Lagrangian derivative\footnotemark}{\index{Lagrange!derivative|see{material derivative}}\index{material!derivative}\index{advective}\label{lagrange:lagrangian_derivative}
        ...
        Let $a(q,\dot{q},t)$ be a phase space quantity. Its Lagrangian derivative along a path $\big(q(t),\dot{q}(t)\big)$ in phase space is given by
        \begin{align}
...
\subsection{Liouville's theorem}
    ...
    \newformula{Boltzmann's transport equation}{\index{Boltzmann!transport equation}\index{Vlasov equation}
        ...
        \begin{gather}
            M_{\text{tot}} = \bigintsss_{\Omega(t)}F(q,\dot{q},t)\,d^6x\,.
        \end{gather}
    ...
    Consider a Hamiltonian system with a phase space $\mathcal{V}$. By Liouville's theorem, the phase flow generated by the equations of motion is a volume- or measure-preserving map $g:\mathcal{V}\rightarrow\mathcal{V}$ (\cref{lebesgue:measure_preserving}). This gives rise to the following theorem.
...
\subsection{Continuity equation}
    ...
    \newformula{Reynolds' transport theorem}{\index{Reynolds transport theorem}\index{Leibniz!integral rule}\label{lagrange:reynolds_transport_theorem}
        ...
        \end{gather}
        Combining Equation \eqref{lagrange:jacobian_derivative} with the divergence theorem \ref{vector:divergence_theorem} gives
        \begin{gather}
...
\subsection{Fluid mechanics}
    ...
    \newformula{Cauchy momentum equation}{\index{Cauchy!momentum equation}
        ...
        \end{gather}
        The left-hand side can be rewritten using \cref{lagrange:result1} as
        \begin{gather}
...
\subsection{Lagrangian mechanics}
    ...
    Now it is time to turn to Noether's theorem and, in particular, the version concerning cyclic coordinates (\cref{lagrange:noether_cyclic}). Any diffeomorphism of $M$ induces a diffeomorphism on $TM$ by pushforward.
...
\subsection{Hamiltonian mechanics}
    ...
    \newdef{Fibre derivative}{\index{fibre!derivative}
        ...
        \end{gather}
        As such the classical definition~\ref{lagrange:conjugate_momentum} for conjugate momenta is obtained. In the case of kinetic Lagrangians defined by a metric $g$, it is not hard to see that this boils down to \cref{lagrange:metric_conjugate_momentum}.
    }
...
\subsection{Hamilton--Jacobi equation}
    ...
    Using the Hamiltonian--Jacobi equation~\eqref{lagrange:hamilton_jacobi_equation}, one can obtain the conjugate momenta. A lengthy calculation gives
    \begin{gather}

...
\subsection{Continuity equation}
    ...
    \newformula{Reynolds transport theorem\footnotemark}{\index{Reynolds!transport theorem}\index{Leibniz!integral rule}\label{fluidum:reynolds_transport_theorem}
        ...
        Consider a quantity \[F = \int_{V(t)}f(\vector{q},\dot{\vector{q}},t)dV.\] Combining equation \eqref{fluidum:jacobian_derivative} with the divergence theorem \ref{vector:divergence_theorem} gives
        \begin{gather}

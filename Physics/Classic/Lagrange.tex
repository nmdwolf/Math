...
\subsection{Canonical transformations}
    ...
    \newdef{Hamilton's characteristic function}{\index{Hamilton!characteristic function}\index{energy}
        For time-independent systems the HJE can be rewritten as follows:\footnote{Note that this form is the same as equation \ref{symplectic:hamilton_jacobi} after a redefinition of $H$.}
        \begin{gather}

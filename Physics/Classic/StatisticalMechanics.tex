...
\section{Grand canonical ensemble}
    ...
    \remark{In the case of fermions, i.e. $n_i\in\{0,1\}$, this formula reduces to $\mathcal{Z} = e^{\beta\mu N}Z$, with $N$ the total particle number.}
...
\subsection{Ising model}\index{Ising model}
    ...
    \begin{formula}[Ising Hamiltonian]

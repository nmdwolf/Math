...
\section{Koopman--von Neumann mechanics}\index{Koopman--von Neumann!mechanics}\index[author]{Koopman}\index[author]{von Neumann}
    ...
    \begin{remark}[Linearity]
        Note that, in contrast to the \textit{Schr\"odinger equation} (see, e.g., \cref{qm:TDSE_position}), both the Liouville and KdV equations are linear PDEs in classical mechanics.
    \end{remark}

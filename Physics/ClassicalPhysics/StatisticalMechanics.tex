...
\section{Temperature}
    ...
    \newdef{Temperature}{\index{temperature}\label{statmech:temperature}
    ...
    \begin{axiom}[Second law]\index{thermodynamics!second law}
...
\subsection{Ising model}\index{Ising model}
    ...
    For higher-dimensional lattices, a phase-transition is found at finite temperature. This was first proven by \indexauthor{Onsager} (later simplified by \indexauthor{Yang}\textit{ et al.}) and required considerably more work than the one-dimensional case.

\subsection{Kramers--Wanier duality}\index{Kramers--Wanier duality}

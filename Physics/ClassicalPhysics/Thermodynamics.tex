...
\section{Postulates}
    ...
    \end{axiom}
    \sremark{The operator $\delta$ in the heat and work differentials implies that these are `inexact' differentials, i.e.~they are not the differential of functions of the thermodynamic coordinates alone. See \cref{section:forms} for more information on \textit{differential forms}.}

    \begin{axiom}[Kelvin--Planck formulation of the second law]\index{thermodynamics!second law}
        No machine can completely transfer an amount of heat into work.
    \end{axiom}
    \begin{axiom}[Clausius formulation of the second law]\index{thermodynamics!second law}
    ...
    \newformula{Clausius's inequality}{\index{Clausius!inequality}\label{thermo:clausius_inequality}
        In differential form, the second law becomes
        \begin{gather}

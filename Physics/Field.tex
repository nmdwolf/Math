...
\subsection{Noether's theorem for fields}\index{Noether!theorem}
    ...
    \begin{theorem}[Noether's first theorem$^\dag$]\index{Noether!charge}\label{field:noethers_theorem}

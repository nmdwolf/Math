...
\section{Batalin--Vilkovisky formalism}
    ...
    \newdef{Antifield}{\index{anti-!field}
        ...
        \end{gather}
        The ghost antifields arise as the Koszul--Tate generators induced by the Noether identities (\cref{field:noether_identity}), where the higher antifields correspond to reducibility relations among the symmetries, since the Noether identities $\delta(R^I_a\mathcal{P}_I)=0$ induce elements of $H^1(\delta)$. According to the Koszul--Tate construction, one needs to recursively introduce generators $\mathcal{P}_a$, to account for such higher relations.

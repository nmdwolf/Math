\chapter{Extensions and Unification}
...
\subsection{Worldsheets}
    ...
    \newformula{Nambu-Goto action}{\index{Nambu-Goto action}
        \begin{gather}
            S_\mathrm{NG} := -T_0\int_\Sigma d\Sigma = -\frac{1}{2\pi\alpha'}\int_\Sigma d\Sigma,
        \end{gather}
    }
    ...
    \newformula{Polyakov action}{\index{Polyakov action}
        \begin{gather}
            S_\mathrm{Polyakov} := \frac{T_0}{2}\int_\Sigma\sqrt{-h}h^{ab}g_{\mu\nu}(x)\partial_ax^\mu\partial_bx^\nu d^2\tau.
        \end{gather}
    }

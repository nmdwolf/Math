...
\subsection{Donaldson--Witten theory}\index{Donaldson--Witten theory}
    ...
    In four dimensions, the classification of manifolds is considerably more intricate than in higher dimensions (cf.~\cref{manifold:dim4}). To find invariants, \indexauthor{Donaldson} studied instanton configurations of non-Abelian gauge theories on 4-manifolds. To this end, recall \cref{gauge:instantons} on instantons.

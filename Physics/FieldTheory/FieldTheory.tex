...
\subsection{Gauge algebra}
    ...
    \begin{property}[Noether identities]\label{field:noether_identity}
        ...
        \end{gather}
        for all `indices' $\alpha$. In contrast to Noether's theorem~\ref{classic:noether_cyclic}, these identities do not imply conserved quantities. Instead, they imply that the equations of motion are not independent.
    \end{property}

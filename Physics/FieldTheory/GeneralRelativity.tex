...
\section{Causal structure}\index{causal}
    ...
    \newdef{Cauchy surface}{\index{Cauchy!surface}\index{inextensible}\label{gr:cauchy_surface}
        Consider a Lorentzian manifold $(M,g)$. A curve $\gamma:]a,b[\rightarrow M$ is said to be an \textbf{inextensible timelike curve} if:
        \begin{enumerate}

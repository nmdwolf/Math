...
\section{Phase space}
	...
	\newdef{Phase space}{\index{phase space}
		The set of all possible $n$-tuples $(q^i, p_i)$ of coordinates and associated momenta is called the phase space of the system.
	}
...
\section{Relativistic action}\index{action}

	\newformula{Relativistic free particle}{
    	\begin{equation}
    		S = -m_0c\int ds
    	\end{equation}
    }
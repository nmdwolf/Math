...
\section{Hamilton-Jacobi gather}
\subsection{Canonical transformations}
	...
	\newformula{Hamilton-Jacobi gather}{\index{Jacobi!Hamilton-Jacobi gather}\index{Hamilton!Hamilton-Jacobi gather}\index{Hamilton!principal function}
		...
		\begin{gather}
			\label{lagrange:hamilton-jacobi_gather}

...
\section{Differential-geometric perspective}
    ...
    \newdef{Potential}{\index{potential}\index{gauge!field}
        The homogeneous equation \ref{maxwell:diff_homogeneous} and Poincar\'e's lemma\footnote{See theorem \ref{forms:theorem:poincare}.} imply that there exists a differential 1-form $\mathbf{A}$ such that
        \begin{gather}
            \mathbf{F} = d\mathbf{A}.
        \end{gather}

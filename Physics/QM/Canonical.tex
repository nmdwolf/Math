...
\subsection{Scalar propagator}
    ...
    \newformula{Pauli-Jordan function}{\index{Pauli-Jordan function}
        ...
        \end{gather}
        In the case that $x^0 = y^0$ (ETCR) or $(x-y)^2 < 0$ (spacelike curves), the Pauli-Jordan function is identically 0. (See also the axiom of microcausality \ref{qft:microcausality}).
    }

...
\section{Interaction picture}\index{interaction!picture}\label{section:interaction_picture}
    ...
    \newformula{Schr\"odinger equation}{\index{Schr\"odinger!equation}
        ...
        \begin{gather}
            i\hbar\deriv{}{t}|\psi(t)\rangle_I = \widehat{V}_I(t)|\psi(t)\rangle_I\,.
        \end{gather}
    ...
    \newdef{M\o ller operator}{\index{M\o ller operator}
        ...
        \begin{gather}
            |\psi(0)\rangle = \widehat{\Omega}_\pm|\text{in/out}\rangle\,.
        \end{gather}
        If, for $t\longrightarrow\pm\infty$, the interaction term vanishes, there should exist a wave function $|\phi(t)\rangle$ evolving under the free Hamiltonian such that
        \begin{gather}
...
\subsection{Dyson series}
    ...
    \newformula{Tomonaga--Schwinger equation}{\index{Tomonaga--Schwinger equation}\label{perturbation:tomonaga_schwinger_equation}
        ...
        \begin{gather}
            i\hbar\deriv{}{t}\widehat{U}_I|\psi(0)\rangle_I = \widehat{V}_I(t)\widehat{U}_I|\psi(0)\rangle_I\,.
        \end{gather}
    }

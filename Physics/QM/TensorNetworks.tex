...
\subsection{Finite-dimensional lattices}
    ...
    \newdef{Matrix product state}{\index{matrix product!state}
        ...
        \begin{gather}
            |\psi\rangle = \sum_{\{i_k\}}\tr\Big(\prod_n^NA^{i_n}(n)\Big)|i_1\ldots i_N\rangle.
        \end{gather}
...
\section{Matrix product operators}
    ...
    \newdef{Matrix product operator\footnotemark}{\index{matrix product!operator}
        ...
        \begin{gather}
            \hat{O} = \sum_{\{i_k,j_l\}}\tr\Big(\prod_{m,n=1}^NO^{i_m,j_n}(n)\Big)|i_1\cdots i_N\rangle\langle j_1\cdots j_n|.
        \end{gather}
        In terms of a basis $\{\hat{O}_i\}$ for the space of local operators this becomes:
        \begin{gather}
            \hat{O} = \sum_{\{i_k\}}\tr\Big(\prod_n^NA^{i_n}(n)\Big)\hat{O}_{i_n}.
        \end{gather}
    }

...
\section{Interaction picture}\index{interaction!picture}\label{section:interaction_picture}
    ...
    \newformula{Tomonaga--Schwinger equation}{\index{Tomonaga--Schwinger equation}\label{perturbation:tomonaga_schwinger_equation}
        ...
        \end{gather}
        Although this equation is often called the Tomonaga--Schwinger equation in the literature, this is actually not correct. The Tomonaga--Schwinger equation generalizes the Schr\"odinger equation to allow for evolutions between arbitrary Cauchy surfaces (\todo{add reference}).
    }

...
\subsection{Prequantization}
    ...
    \begin{result}[Dirac quantization condition]\index{quantization!Dirac condition}\label{quantization:dirac_condition}
        Weil integrality implies that, The minimal coupling procedure, where $\nabla$ is coupled to an external gauge field, is given by the following substitution: $\omega\longrightarrow\omega+eF$. Weil integrality then implies that $e$ is an integer.

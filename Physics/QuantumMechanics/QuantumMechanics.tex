...
\subsection{Pauli theory}
    ...
    Consider a charge $q$ moving though an electromagnetic field with potential $\mathbf{A}\equiv(\varphi,\vector{A})$. In classical physics, the potential is often considered `nonphysical', as only the fields themselves are measurable. However, when also including quantum mechanics, this picture changes (see the next subsection).

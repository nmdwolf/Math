...
\section{Maxwell-Boltzmann statistics}\index{Maxwell!Maxwell-Boltzmann statistics}

	\begin{formula}[Partition function]\index{partition!function}\label{statmech:partition_function}
		\begin{equation}

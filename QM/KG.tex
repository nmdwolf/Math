...
\subsection{Bosonic fields}
	...
	\[\phi = \phi^{(+)} + \phi^{(-)}\]
	where the + symbol denotes the 'positive frequency' part, i.e. the part consisting of annihilation operators\footnote{By looking at equation \ref{qft:phi}, we see that the annihilators always occur together with a positive sign exponential.}. The 'negative frequency' part is defined analogously.

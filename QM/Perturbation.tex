...
\subsection{Dyson series}
	...
	\newformula{Tomonaga-Schwinger equation}{\index{Schwinger!Tomonaga-Schwinger equation}
		The evolution operator $\hat{U}(t)$ satisfies the following Schr\"odinger-type equation in the interaction image\footnote{See section \ref{qm:interaction_pciture}.}:
        	\begin{equation}

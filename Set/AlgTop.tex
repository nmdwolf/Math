...
\subsection{Homotopy groups}
    ...
    \begin{property}[Eckmann-Hilton duality]\index{Eckmann-Hilton duality}
        The reduced suspension functor $\Sigma$ and the loop space functor $\Omega$ form an adjunction on the category of point spaces:
        \begin{gather}
            \text{Map}_\ast(\Sigma X, Y)\cong\text{Map}_\ast(X, \Omega Y).
        \end{gather}
    \end{property}
    \begin{result}
...
\section{\difficult{Axiomatic approach}}
    ...
    \begin{theorem}[Brown's representability theorem]\index{Brown's representability theorem}

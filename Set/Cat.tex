...
\subsection{Morphisms}
	...
	\newdef{Generator\footnotemark}{\index{generator}\label{cat:generator}
		...
		Let $C$ be a category. A collection of objects $\{o_i\in\ob(C)\}_{i\in I}$ is called a collection of generators for $C$ if given any two objects $a, b\in\ob(C)$ and any two morphisms $f, g:a\rightarrow b$ we have that $f\neq g\implies\exists j\in I, h_j\in\hom_C(o_i, a): f\circ h_j\neq g\circ h_j$.
	}

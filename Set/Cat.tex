...
\section{Adjunctions}
	...
	\begin{notation}
		An adjunction$(F, G)$ between categories $\mathbf{C}, \mathbf{D}$ is often denoted by:\[\textbf{C}\adj{F}{G}\textbf{D}\]
	\end{notation}
...
\section{Model categories}
	...
	\newdef{Acyclic}{\index{acyclic!fibration}
		The morphisms in Fib$\cap W$ and Cof$\cap W$ are called \textbf{acyclic} or \textbf{trivial} fibrations and cofibrations.
	}

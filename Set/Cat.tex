...
\subsection{Monads}
    ...
    \newdef{Closure operator}{\index{closure!operator}\index{modal operator|see{closure operator}}\index{modal!type}\label{cat:closure_operator}
        ...
        An object $c\in\ob{C}$ is called a \textbf{modal type} if the unit $\eta_c:c\rightarrow Tc$ is an isomorphism.
    }
...
\section{Internal structures}\index{internal}
    ...
    \begin{property}[Eckmann-Hilton argument]\index{Eckmann-Hilton!argument}\label{category:eckmann_hilton}

...
\subsection{Free groups}
    ...
    \begin{theorem}[Fundamental theorem of finitely generated groups]\index{fundamental theorem!for finitely generated groups}\index{torsion}\label{group:theorem:free_group}
...
\section{Group actions}
    ...
    \begin{adefinition}\label{group:permutation_remark}
        A group action can equivalently be defined as a group morphism $\rho:G\rightarrow\text{Sym}(V)$. It assigns a permutation of $V$ to every element $g\in G$. If the set $V$ is equipped with some extra algebraic structure then we replace $\text{Sym}(V)$ by $\text{Aut}(V)$, i.e. we require the action of $G$ to respect this extra structure.
    \end{adefinition}

...
\section{Exact sequences}
	...
	\newdef{Short exact sequence}{\label{homalg:short_exact_sequence}
		...
		\begin{gather}
			0\longrightarrow A_0\xrightarrow{\Phi_1}A_1\xrightarrow{\Phi_2} A_3\longrightarrow0.
		\end{gather}
...
\section{Resolutions}
    ...
    \begin{property}[Null-homotopy implies acyclicity]\label{homalg:null_acyclic}
        If a null-homotopic chain map $f:C_\bullet\rightarrow C_\bullet$ exists, then $C_\bullet$ is acyclic.
    \end{property}

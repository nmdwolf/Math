...
\section{General definitions}
        ...
        \newdef{Metric space}{
        	A set $M$ equipped with a metric $d$ is called a metric space. This is often denoted by $(M,d)$.
        }
        
        \newdef{Diameter}{\index{diameter}
        	The diamater of a subset $U\subset M$ is defined as follows:
		\begin{gather}
        ...
        \newdef{Convergence}{\index{convergence}
        	A sequence $(x_n)_{n\in\mathbb{N}}$ in a metric space $(M, d)$ is said to be convergent to a point $a\in M$ if:
		\begin{gather}
...
\section{Examples of metrics}
	...
	\newdef{Product space}{\index{product!space}
		Consider the cartesian product \[M = M_1\times M_2\times ... \times M_n\] where $(M_i,d_i)$ is a metric space for all $i\leq n$. Equipped with the distance function $d(x,y) = \underset{1\leq i\leq n}{\max}\ d_i(x_i,y_i)$ this product becomes a metric space.
	}
...
\section{Completeness}
	...
	\newdef{Cauchy sequence}{\index{Cauchy!sequence}
		...
		\begin{gather}
			...
			\boxed{(\forall\varepsilon>0)(\exists N\in\mathbb{N})(\forall m, n\geq N)(d(x_m, x_n) < \varepsilon)}
		\end{gather}
	}

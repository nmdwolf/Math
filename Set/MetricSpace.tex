...
\section{Injective metric spaces}
		...
		A metric space $M$ is said to be injective if whenever $M$ is isometric to a subspace $Y$ of a metric space $X$ then $Y$ is a retract of $X$.
	}

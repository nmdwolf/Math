...
\section{Geometric morphisms}
	...
	\newnot{Category of topoi}{
		...
		The category of elementary topoi and geometric morphisms forms a (2-)category. We will denote this 2-category by \textbf{Topos}.
	}
...
\section{Grothendieck topos}
	...
	\begin{example}[Maximal sieve]
			Let $\mathbf{C}$ be a category. The maximal sieve on $c\in\ob{C}$ is the collection of all morphisms $\{f\in\text{hom}(\textbf{C}):\cod(f) = c\}$ or equivalently all of $\text{ob}(\mathbf{C}/c)$.
	\end{example}

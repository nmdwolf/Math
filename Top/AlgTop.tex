...
\subsection{Homotopy groups}
    ...
    \newdef{Homotopy group}{\index{homotopy!group}
        ...
        The homotopy group $\pi_n(X, x_0)$ is defined as the set of homotopy classes of continuous maps $f:S^n\rightarrow X$ based at $x_0\in X$. The set $\pi_0(X, x_0)$ can be seen to be the set of path-connected components of $X$. (This explains why we introduced the notation $\pi_0(X)$ before.)
    }
    ...
    \end{property}
    \begin{property}[Abelian groups]\label{topology:abelian_homotopy_groups}
...
\subsection{Simplicial homology}
    ...
    \begin{formula}[Euler characteristic]\index{Euler!characteristic}\index{Euler-Poincar\'e formula}\label{topology:euler_characteristic}

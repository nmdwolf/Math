...
\subsection{Homotopy groups}
    ...
    \newdef{Postnikov tower\footnotemark}{\index{Postnikov tower}\index{Whitehead!tower}
        ...
        \begin{itemize}
            \item For all $i\leq n$ there exists an isomorphism $\pi_i(X)\cong\pi_i(X^n)$.
        ...
        such that:
        \begin{itemize}
            \item For all $i>n$ the induced maps $\pi_i(X_n)\rightarrow\pi_i(X)$ are isomorphisms.
...
\subsection{Simplicial homology}
    ...
    \begin{property}[Chain condition]

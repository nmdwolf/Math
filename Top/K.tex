...
\subsection{Classification}
    ...
    \begin{property}[Classifying space of orthogonal group]\index{classifying!space}
        Consider the classifying space \ref{diff:classifying_space} of the orthogonal group $\mathrm{O}(n)$ and recall the Grassmannian $\mathrm{Gr}(n,\mathbb{R}^N)$ of $n$-dimensional subspaces in $\mathbb{R}^k$. There exists a canonical inclusion of Grassmannians:
        \begin{gather}

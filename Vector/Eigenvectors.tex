\section{Eigenvectors}
	...
	\begin{theorem}[Characteristic equation\footnotemark]\label{linalgebra:theorem:eigenvalue_characteristic_equation}
...
\subsection{Diagonalization}
    	...
    	\newdef{Diagonalizable operator}{
    		Let $V$ be a finite-dimensional $K$-vector space. An operator $f\in\text{End}_K(V)$ is diagonalizable if there exists a matrix representation $A\in M_n(K)$ of $f$ such that $A$ is a diagonal matrix.
    	}

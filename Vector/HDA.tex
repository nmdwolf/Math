...
\subsection{Berezin calculus}\label{section:berezin}
    ...
    \newdef{Derivative of Grassmann variables}{
        ...
        \begin{gather}
            \pderiv{}{\theta_j}\theta_i = \delta^i_j\qquad\qquad\qquad\theta_i\pderiv{}{\theta_j}+\pderiv{}{\theta_j}\theta_i = 0
        \end{gather}
        ...
        \begin{gather}
            \theta_i\Rderiv{}{\theta^j} = \delta^i_j.
        \end{gather}
    }

    After differentiation, one also needs some kind of integration theory. Instead of working with a definition \`a la Riemann, the integral will be defined purely axiomatically:

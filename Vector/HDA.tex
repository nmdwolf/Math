\chapter{Higher-dimensional algebra}
	...
	The main reference for this chapter is the series of papers carrying the same name by John Baez et al.

\section{Tensor and fusion categories}

	This and the following section is mainly based on \cite{etingof}. However, some definitions might be slightly different and some properties might be stated less generally. By $k$ we will mean an algebraically closed field (often this will be $\mathbb{C}$).

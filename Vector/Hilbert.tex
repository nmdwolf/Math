...
\subsection{Spectrum}
	...
	\newdef{Point spectrum}{
		The set of scalars $\mu\in\mathbb{C}$ for which the resolvent of $A$ fails to be injective is called the point spectrum of $A$. This set coincides with the set of eigenvalues of $A$.
	}

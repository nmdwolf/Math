\chapter{Banach spaces and Hilbert spaces}
	...
	In this chapter the term "linear operator", which is normally reserved for maps of the form $f:V\rightarrow V$, is used instead of "linear map". This was done to keep the vocabulary in track with that of the standard literature on Banach and operator spaces.
...
\subsection{Inner products and norms}
	...
	\begin{formula}[Parallellogram law]\index{parallellogram law}
		...
		\end{equation}
	\end{formula}
	\begin{formula}[Polarization identity]\index{polarisation identity}
		\begin{equation}

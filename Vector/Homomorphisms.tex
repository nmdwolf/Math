...
\subsection{Convex functions}
	...
	\begin{theorem}[Karamata's theorem]\index{Karamata's theorem}
		Let $I\subset\mathbb{R}$ be an interval and let $f:I\rightarrow\mathbb{R}$ be a convex function. If $(x_1, ..., x_n)$ is a tuple that majorizes $(y_1, ..., y_n)$ then:
		\eq{
			\sum_{k=1}^nf(x_k)\geq \sum_{k=1}^nf(y_k)
		}
	\end{theorem}
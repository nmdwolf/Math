\section{Inner product}\label{linalgebra:innerproduct}
	...
	\remark{\index{Hermitian!form}
		\label{linalgebra:NDH_form}
    		Inner products are special cases of \textbf{non-degenerate Hermitian forms} which do not satisfy the positive-definiteness property.
	}
...
\subsection{Orthogonality}\label{linalgebra:section:orthogonality}
	...
	\newdef{Orthogonal}{
		...
		\begin{equation}
			...
			\langle v|w \rangle = 0
		\end{equation}
		An orthogonal \textbf{system} is a set of vectors, none of them equal to 0, that are mutually orthogonal.
	}
	\begin{property}
	...
	\newdef{Orthonormal}{
        ...
        \newdef{Orthogonal complement\footnotemark}{\label{linalgebra:orthogonal_complement}
        	\footnotetext{$W^\perp$ is pronounced as 'W-perp'.}
        	Let $W$ be a subspace of $V$. The following subspace is called the orthogonal complement of $W$:
        	\begin{equation}
        ...
        \begin{property}
		Let $V$ be a finite-dimensional $K$-vector space. The orthogonal complement $W^\perp$ is a complementary subspace\footnote{hence the name} to W, i.e. $W\oplus W^\perp=V$.
	\end{property}

...
\subsection{Self-adjoint operators}
    ...
    There is a multitude of different notions available in the literature that try to indicate in what sense an operator is related to its adjoint (not everyone agrees on the definitions). Here we give an overview in the case of Hilbert spaces. All operators are allowed to be unbounded.

...
\section{Hilbert spaces}
    ...
    \begin{formula}[Pythagorean theorem]\index{Pythagorean theorem}\label{functional:pythagorean_theorem}
...
\subsection{Orthogonality and projections}
    ...
    \newdef{Trace}{\index{trace}\label{functional:trace}
        ...
        \begin{gather}
            \mathrm{tr}(S) := \sum_{i\in I}\langle Se_i,e_i \rangle.
        \end{gather}
    }
...
\subsection{Tensor products}\index{tensor!product}
    ...
    \newdef{Tensor product of Banach spaces}{
        ...
        \begin{gather}
            \|x\|_\mathrm{proj} := \inf\left\{\sum_{i=1}^n\|a_i\|\|b_i\|\,\middle\vert\,x=\sum_{i=1}^na_i\otimes b_i\right\}
        \end{gather}
        and
        \begin{gather}
...
\subsection{Bounded operators}
    ...
    \newdef{Schatten class operator}{\index{Schatten class}
        ...
        \begin{gather}
            \|T\|_p = \mathrm{tr}\left(\sqrt{T^*T}^{\ p}\right)^{1/p}.
        \end{gather}

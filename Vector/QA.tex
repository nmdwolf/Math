...
\section{Coalgebras}
    ...
    \begin{example}
        ...
        \begin{gather}
            \varepsilon(e_i) := 1.
        \end{gather}
        By linearity these maps can be extended to all of $V$. Important cases are the tensor algebra and exterior algebra over a vector space. (See Definitions \ref{vector:tensor_algebra} and \ref{vector:exterior_algebra}.)
    \end{example}

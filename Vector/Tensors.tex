...
\subsection{Hodge star}
	...
	\newdef{Volume element}{\index{volume}
	    	Let $V$ be an $n$-dimensional vector space. A volume element on $V$ is a distinct choice of top-dimensional exterior form on $V$, i.e. a distinct choice of Vol$\in\Lambda^n(V)$.
	    	
	    	When equipped with an inner product and hence an orthonormal basis $\{e_i\}$, there exists a canonical volume form given by Vol$ = e_1\wedge...\wedge e_n$. This will be the convention adopted in the remainder of this section.
	}

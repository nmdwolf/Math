\section{Vector spaces}
	...
	\begin{remark}
		...
		\end{itemize}
		It follows that for finite-dimensional spaces we do not have to worry. In infinite-dimensional spaces however we have to keep this in mind. An alternative, which allows infinitely many elements is given by the concept of a \textit{Schauder} basis.\index{Schauder basis}
	\end{remark}
...
\section[Linear maps]{Linear maps\footnote{Other names are \textbf{linear mapping} and \textbf{linear transformation}.}}
	...
	\begin{theorem}\label{linalgebra:theorem:inverse}

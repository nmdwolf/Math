...
\input{Math/Set/Model}
\input{Math/Set/Topoi}

\part{Calculus}
\input{Math/Calculus/Calculus}
\input{Math/Calculus/ComplexCalculus}
\input{Math/Calculus/Lebesgue}
...
\input{Math/Vector/Rep}
\input{Math/Vector/Normed}
\input{Math/Vector/Operators}
\input{Math/Vector/Clifford}
\input{Math/Vector/QA}

...
\input{Math/Set/Set}
\input{Math/Set/Algebra}
\input{Math/Set/Ring}
\input{Math/Set/Category}
\input{Math/Set/HomAlg}
\input{Math/Set/Type}
...
\input{Math/Top/MetricSpace}
\input{Math/Top/AlgGeom}
\input{Math/Set/ModelCat}
...
\input{Math/Vector/Representation}
\input{Math/Vector/Functional}
\input{Math/Vector/Operators}
\input{Math/Vector/Clifford}
\input{Math/Vector/QuantumAlgebra}
\input{Math/Vector/HDA}

\part{Differential Geometry}\label{part:diffgeom}
\input{Math/Diff/Surface}
...
\input{Physics/Field/CanonicalQuantization}
\input{Physics/Field/GaugeTheory}
\input{Physics/Field/QCD}
\input{Physics/Field/CFT}
\input{Physics/Field/SUSY}
\input{Physics/Field/EntanglementQFT}
...
\input{Math/Derivations}
\input{Physics/Derivations}
\input{Physics/QM/Derivations}
\input{Notes}
\end{appendices}
